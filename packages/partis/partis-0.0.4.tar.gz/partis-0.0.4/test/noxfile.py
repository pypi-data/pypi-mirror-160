...
# Config
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
root_dir = osp.join( osp.dirname(osp.abspath(__file__)), os.pardir )
pptoml_file = osp.join( root_dir, 'pyproject.toml' )
sitcustom_dir = osp.join( root_dir, 'test', 'sitecustom' )
flake8_file = osp.join( root_dir, 'test', '.flake8' )
