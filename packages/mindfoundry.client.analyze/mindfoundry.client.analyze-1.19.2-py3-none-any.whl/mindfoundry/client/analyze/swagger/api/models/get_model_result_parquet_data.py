...
def sync(
    *,
    ...
    """ Get the model result as a parquet file - For classification & regression this result is the result of hold-out test, for clustering it is the clustered data. """
