...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/cecep/python_projects/iso-freeze/.direnv/iso-freeze-3.11'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/cecep/python_projects/iso-freeze/.direnv/iso-freeze-3.11/bin/deactivate.nu'
