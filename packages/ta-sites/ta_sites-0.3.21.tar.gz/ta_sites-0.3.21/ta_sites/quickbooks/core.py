    ...
    def login_to_site(self) -> bool:
        ...
        for i in range(1, 4):
            try:
                ...
                if self.does_element_displayed('//input[@id="ius-password"]'):
                ...
                elif self.does_element_displayed('//input[@id="iux-password-confirmation-password"]'):
                    self.browser.input_text('//input[@id="iux-password-confirmation-password"]', self.password)
                    ...
                    if self.does_element_displayed('//input[@id="iux-password-confirmation-password"]'):
                        self.browser.input_text('//input[@id="iux-password-confirmation-password"]', self.password)
                        self.browser.click_element_when_visible(
                            '//button[@data-testid="passwordVerificationContinueButton"]'
                        )
