...
class XMPMetadata(Graph):
    ...
    def getDate(self, predicate=XMP.MetadataDate):
        ...
        if value:
            ...
            return self.iso8601.parse(date_candidate) if isinstance(date_candidate,
                                                                    str) else date_candidate
        else:
            return None
    ...
    def container2repeated(self, predicate,
                           new_predicate=None, value_mapper=identity):
        ...
        if items:
            ...
            for item in items:
                self.add((self.url, new_predicate, value_mapper(item)))
