...
class Search():
    ...
    def check_sol_already_generated(self, har_mem, sol):
        ...
        check_sol = sol in new_har_mem

        # TODO! Notes
        # does har_mem inc. bic, MAE, loglik ?
        # logic for lcm when generated vars not in class_params_spec...
    ...
    def initialize_memory(self, HMS):
        ...
        while dummy_iter < 30000:
            ...
            all_HM = HM + opp_HM
            check_sol = self.check_sol_already_generated(all_HM, sol)
            if not check_sol:
            ...
            all_HM = HM + opp_HM
            check_sol = self.check_sol_already_generated(all_HM, opp_sol)
            if not check_sol:
    ...
    def assess_sol(self, solution, har_mem):
        ...
        # all_HM = HM + opp_HM
        check_sol = self.check_sol_already_generated(har_mem, solution)
