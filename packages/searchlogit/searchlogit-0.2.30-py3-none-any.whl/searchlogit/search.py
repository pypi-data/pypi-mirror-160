        ...
        if all_vars:
            ...
            try:
                bic, val, asvars, isvars, randvars, \
                    bcvars, corvars, conv, sig, sig_member, coefs = self.fit_model(sol)
    ...
    def check_sol_already_generated(self, sol):
        ...
        for har_mem_sol in new_har_mem:
            ...
            if np.all(bool_arr):
                ...
                return True
        # key_bools = []
        # for sol_k, sol_v in sol_i:
        #     pass
        # sol_already_generated = np.all(sol_i in new_har_mem)
