...
setuptools.setup(
    ...
    url="https://github.com/songjian/pynetease-finance",                              # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
