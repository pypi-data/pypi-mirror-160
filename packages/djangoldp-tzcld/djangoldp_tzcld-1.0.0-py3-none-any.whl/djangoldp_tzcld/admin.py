...
from djangoldp_tzcld.models import TzcldProfile, TzcldCommunity, TzcldTerritoriesKind, TzcldProfileOrganisation, TzcldProfileEvent
...
class TzcldProfileAdmin(DjangoLDPAdmin):
    ...
    inlines = [TzcldOrgsInline, TzcldEventsInline]
    ordering = ['user']
