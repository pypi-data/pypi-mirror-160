...
class BaseUser:
    ...
    def admin_consent(self) -> int:
        """
        [Global administrator only] prompt to sign in and do admin consent of SeqsLab Enterprise Applications. For headless OS, an admin consent URL is returned, and the URL must be accessed in order to proceed with the admin consent task."
        """
        ...
        cprint(f'Please copy the URL to a browser to proceed with the admin consent {ret}', 'yellow')
        return 0
    ...
    @argument("email",
              type=str,
              positional=False,
              description="The email account that is going to be added as a SeqsLab user account (required).")
    @argument("roles",
              type=List[str],
              positional=False,
              description="The role the added user is going to be assigned to (required).")
    @argument("active",
              type=bool,
              positional=False,
              description="Whether or not to activate the registered user (optional, default = False).")
    @argument("name",
              type=str,
              positional=False,
    ...
    @argument("email",
              type=str,
              positional=False,
              description="The email account that is going to be added as SeqsLab user account (optional).")
    @argument("roles",
              type=List[str],
              positional=False,
              description="The role the added user is going to be assigned to (optional).")
    @argument("active",
              type=bool,
              positional=False,
              description="Whether or not to activate the registered user (optional).")
    @argument("name",
              type=str,
              positional=False,
              description="User name (optional).")
