...
class BaseDatahub:
    ...
    @argument("workspace",
              type=str,
              positional=False,
              description="user workspace. (Required)", )
    @argument("src",
              type=URL,
              positional=False,
    ...
    @argument("dst",
              type=str,
              positional=False,
              description="destination directory, file path. (Required)")
    @argument("concurrency",
              type=int,
              positional=False,
              description="Specify the numbers of chunks that can be transferred concurrently.  The download bandwidth can be "
                          "estimated using the formula concurrency * chunk_size."
    ...
    @argument("overwrite",
              type=bool,
              positional=False,
              description="overwrite the exist files.(Optional, Default = False)")
    def download(self, workspace: str, dst: str, id: str = None, uri: URL = None, overwrite: bool = False,
        ...
        """
        Download the content of DRS object to a file or directory path.
        """
    ...
    @argument("Authorizations",
              ...
              description="Provide the authorization credentials for the storage location "
                          "where you want to store the object (optional)"
                          "(must not be in stdin mode)")
    @argument("checksum",
              type=str,
              positional=False,
    ...
    @argument("id",
              type=str,
              positional=False,
              description="The customized object id. (optional)")
    ...
    @argument("drs_id",
              type=List[str],
              positional=False,
              description="The object id that will be register in the bundle. (Required)")
    @argument("name",
              type=str,
    ...
    @argument("id",
              type=str,
              positional=False,
              description="The customized bundle id. (Optional)")
    @argument("output",
              type=str,
              positional=False,
              description="Specify the output format of the stdout file (default = json) (optional).",
    ...
    def _register_bundle(name: str, drs_ids: List[str], workspace: str, stdin: bool = False, **kwargs) -> List[dict]:
        backend = drs_register().load_register(workspace)
        if stdin:
            raise NotImplementedError("This functions will be created soon.")
        else:
            payloads = [{
                "name": name,
