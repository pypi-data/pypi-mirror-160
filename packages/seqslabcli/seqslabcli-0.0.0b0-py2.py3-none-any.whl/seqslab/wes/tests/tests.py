...
class CommandSpecTest(BasicTest):
    ...
    def test_run(self):
        ...
        exit_code = shell.run_cli_line(f"test_shell run --working-dir {working_dir}")
        assert exit_code == 0
    ...
    def test_schedule(self):
        ...
        exit_code = shell.run_cli_line(f"test_shell schedule --run-request-id {run_request_id} --schedule-tag {run_request_id}")
        assert exit_code == 0
