...
class BaseJobs:
    ...
    def concurrency(self) -> int:
        """Specify the maximum concurrency that you want to use when copying each file."""
    ...
    def schedule(self,
        ...
        are left blank for future runtime sample-resolving. Thus, by specifying sample-resolving rule,
    ...
    @argument("execs",
              type=str,
              description="Specify the execs.json needed for create WES request.  If not given, the command will "
    ...
    @argument("trust",
              ...
              description="Specify whether to enable content trust for container runtime "
                          "(optional, default = False).")
    def request(self, run_name: str, working_dir: str, workflow_url: str, execs=None, runtimes=None, integrity=False,
                trust=False):
        """
...
class Jobs(BaseJobs):
    ...
    @argument("working_dir",
              type=str,
              positional=False,
              description="working directory path containing request.json. (Required)"
              )
    def dryrun(self,
               working_dir: str,
               ) -> int:
