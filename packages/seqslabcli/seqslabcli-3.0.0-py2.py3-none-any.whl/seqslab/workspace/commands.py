...
class BaseWorkspace:
    ...
    @argument("location",
              ...
              positional=False,
              description="Workspace location. (Required)")
    ...
    @argument("task_id",
              type=str,
              positional=False,
              description="create workspace task id. (Required)")
    ...
    @argument("expand",
              type=bool,
              positional=False,
              description="Not recommend. (Required)")
    @argument("system",
              type=str,
              positional=False,
              choices=["wes", "drs", "trs"],
              description="The system that workspace according to. (Optional)")
