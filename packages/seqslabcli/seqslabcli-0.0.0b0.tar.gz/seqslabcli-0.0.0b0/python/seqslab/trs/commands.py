...
class BaseTools:
    ...
    @argument("workspace",
              type=str,
              description="The workspace according to the sign-in account. (Required)")
    ...
    @argument("tool_id",
              type=str,
              description="TRS ID. (Required)")
    @argument("version_id",
              type=str,
              description="TRS version. (Required)")
    ...
    @argument("version_id",
              type=str,
              description="TRS version. (Required)(Required)")
    @argument("descriptor_type",
              type=str,
              description="TRS type. (Optional: default is WDL)",
              choices=['WDL', 'CWL'])
    @argument("download_path",
              type=str,
              description="The file path of the downloaded tool zip file. (Required)")
