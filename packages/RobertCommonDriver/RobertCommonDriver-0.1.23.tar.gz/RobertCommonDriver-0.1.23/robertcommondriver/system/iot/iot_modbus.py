    ...
    def template(cls, mode: int, type: str, lan: str) -> List[Dict[str, Any]]:
        ...
        if type == 'point':
            templates.extend([
                ...
                {'required': True, 'name': '功能吗' if lan == 'ch' else 'fun code'.upper(), 'code': 'point_fun_code', 'type': 'int', 'default': '1', 'enum': [], 'tip': ''},
            ...
            if mode == 0:
                templates.extend([
                    ...
                    {'required': True, 'name': '超时(s)' if lan == 'ch' else 'Timeout(s)', 'code': 'time_out', 'type': 'int', 'default': 5, 'enum': [], 'tip': ''},
                ])
