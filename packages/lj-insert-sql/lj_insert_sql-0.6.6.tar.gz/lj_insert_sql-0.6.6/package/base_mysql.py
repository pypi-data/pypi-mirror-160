...
LastEditTime: 2022-07-21 14:45:14
...
from package.lj_sqlpackage import PackageDeps, PackageInfo, PackageVersion, SqlTool
...
class ToMysql:
    ...
    def set_mysql_info(self, insert_data, increment_fields):
        """
...
b = {"host":"localhost", "port":3306, "user":"root", "pwd":"123", "charset":"utf8", "db":"data_center"}
tomysql = ToMysql('hex_info',1, a, b)
tomysql.set_mysql_info({'1':2},{'1':'2'})
