...
class PackageInfo(Base):
    TABLE_NAME = 'hex_packages_info'
    FIELDS = ('package_name', 'lj_package_id', 'package_type', 'home_page', 'github_url',
              'latest_release', 'description', 'license', 'verified_license', 'license_status',)
    UNIQUE_FIELDS = ('package_name',)

    def __init__(self, package_name, lj_package_id=None, package_type=None, home_page=None, github_url=None,
                 latest_release=None, description=None, license=None, verified_license=None, license_status=None, ):
        self.package_name = package_name
        self.lj_package_id = lj_package_id
        self.package_type = package_type
        ...
        self.verified_license = verified_license
