...
class ChromeDriver():
    ...
    NB: ChromeDriver requires a working internet conenction to download the latest
    release of the chromedriver applicable to the current installation of Google
    Chrome.
    """
    def __init__(self):
        super().__init__()
        self.webdriver, self.action_chains = self._setup_chromedriver()
    ...
    def press(self, key: Keys, number_of_times=1):
        ...
        for _ in range(number_of_times):
            self._action_chains.key_down(key).perform()
    ...
    def _setup_chromedriver(self):
        ...
        try:
            ...
            return webdriver, action_chains
