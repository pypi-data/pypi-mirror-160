...
def sech_pulse_stf(
    ...
    ...     graph=graph, output_node_names=["sech_samples"]
    ... )
...
def linear_ramp_stf(
    ...
    >>> ramp = graph.pulses.linear_ramp_stf(slope=4.0, shift=-2.0)
    <Stf: operation_name="add", value_shape=(), batch_shape=()>
    >>> graph.sample_stf(stf=ramp, sample_times=np.linspace(0, 1, 5), name="linear_ramp")
