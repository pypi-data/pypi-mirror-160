...
class AsyncRabbitQueueAdapter(BrokerUsecase):
    ...
    def __init__(
        ...
        self.connection_data = connection_data or ConnectionData(
            host or settings.RABBIT_HOST, port or settings.RABBIT_PORT,
            login or settings.RABBIT_LOGIN, password or settings.RABBIT_PASSWORD,
            vhost or settings.RABBIT_VHOST
        )
        self._url = url
        self.connect()
