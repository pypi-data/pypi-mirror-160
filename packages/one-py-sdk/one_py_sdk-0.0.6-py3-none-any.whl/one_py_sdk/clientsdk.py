...
class ClientSdk:
	def __init__(self, env="https://api-us.aquaticinformatics.net/", cacheTimeout=180):
	...
	def Initialize(self, cacheTimeout):
		...
		requests_cache.install_cache("client-cache", backend="sqlite", expire_after=cacheTimeout)
