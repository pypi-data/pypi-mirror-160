...
class Matrix(LinOp):
    ...
    def __init__(self, *args):
        ...
        __init__(Matrix self, Matrix A) -> Matrix
...
class SparseMatrix(LinOp):
    ...
    def __init__(self, *args):
        ...
        __init__(SparseMatrix self, size_t N, size_t M) -> SparseMatrix
        """
...
class Geometry(object):
    ...
    conductivity_difference = _swig_new_instance_method(_openmeeg.Geometry_conductivity_difference)
    oriented = _swig_new_instance_method(_openmeeg.Geometry_oriented)
...
class HeadMat(SymMatrix):
    r"""Proxy of C++ OpenMEEG::HeadMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, geo, gauss_order=3):
        r"""__init__(HeadMat self, Geometry geo, unsigned int const gauss_order=3) -> HeadMat"""
        _openmeeg.HeadMat_swiginit(self, _openmeeg.new_HeadMat(geo, gauss_order))
    __swig_destroy__ = _openmeeg.delete_HeadMat

# Register HeadMat in _openmeeg:
_openmeeg.HeadMat_swigregister(HeadMat)

class SurfSourceMat(Matrix):
    r"""Proxy of C++ OpenMEEG::SurfSourceMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, geo, sources, gauss_order=3):
        r"""__init__(SurfSourceMat self, Geometry geo, Mesh sources, unsigned int const gauss_order=3) -> SurfSourceMat"""
...
# Register SurfSourceMat in _openmeeg:
_openmeeg.SurfSourceMat_swigregister(SurfSourceMat)

class DipSourceMat(Matrix):
    r"""Proxy of C++ OpenMEEG::DipSourceMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(DipSourceMat self, Geometry geo, Matrix dipoles, unsigned int const gauss_order=3, bool const adapt_rhs=True, std::string const & domain_name="") -> DipSourceMat"""
        _openmeeg.DipSourceMat_swiginit(self, _openmeeg.new_DipSourceMat(*args))
    __swig_destroy__ = _openmeeg.delete_DipSourceMat

# Register DipSourceMat in _openmeeg:
_openmeeg.DipSourceMat_swigregister(DipSourceMat)

class EITSourceMat(Matrix):
    r"""Proxy of C++ OpenMEEG::EITSourceMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, geo, electrodes, gauss_order=3):
        r"""__init__(EITSourceMat self, Geometry geo, Sensors electrodes, unsigned int const gauss_order=3) -> EITSourceMat"""
...
# Register EITSourceMat in _openmeeg:
_openmeeg.EITSourceMat_swigregister(EITSourceMat)

class Surf2VolMat(Matrix):
    r"""Proxy of C++ OpenMEEG::Surf2VolMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, geo, points):
        r"""__init__(Surf2VolMat self, Geometry geo, Matrix points) -> Surf2VolMat"""
        _openmeeg.Surf2VolMat_swiginit(self, _openmeeg.new_Surf2VolMat(geo, points))
    __swig_destroy__ = _openmeeg.delete_Surf2VolMat

# Register Surf2VolMat in _openmeeg:
_openmeeg.Surf2VolMat_swigregister(Surf2VolMat)

class Head2EEGMat(SparseMatrix):
    r"""Proxy of C++ OpenMEEG::Head2EEGMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, geo, electrodes):
        r"""__init__(Head2EEGMat self, Geometry geo, Sensors electrodes) -> Head2EEGMat"""
...
# Register Head2EEGMat in _openmeeg:
_openmeeg.Head2EEGMat_swigregister(Head2EEGMat)

class Head2ECoGMat(SparseMatrix):
    r"""Proxy of C++ OpenMEEG::Head2ECoGMat class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(Head2ECoGMat self, Geometry geo, Sensors electrodes, Interface i) -> Head2ECoGMat
        __init__(Head2ECoGMat self, Geometry geo, Sensors electrodes, std::string const & id) -> Head2ECoGMat
        """
        _openmeeg.Head2ECoGMat_swiginit(self, _openmeeg.new_Head2ECoGMat(*args))
    __swig_destroy__ = _openmeeg.delete_Head2ECoGMat

# Register Head2ECoGMat in _openmeeg:
_openmeeg.Head2ECoGMat_swigregister(Head2ECoGMat)

class Head2MEGMat(Matrix):
    r"""Proxy of C++ OpenMEEG::Head2MEGMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, geo, sensors):
        r"""__init__(Head2MEGMat self, Geometry geo, Sensors sensors) -> Head2MEGMat"""
        _openmeeg.Head2MEGMat_swiginit(self, _openmeeg.new_Head2MEGMat(geo, sensors))
    __swig_destroy__ = _openmeeg.delete_Head2MEGMat

# Register Head2MEGMat in _openmeeg:
_openmeeg.Head2MEGMat_swigregister(Head2MEGMat)

class SurfSource2MEGMat(Matrix):
    r"""Proxy of C++ OpenMEEG::SurfSource2MEGMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, sources, sensors):
        r"""__init__(SurfSource2MEGMat self, Mesh sources, Sensors sensors) -> SurfSource2MEGMat"""
...
# Register SurfSource2MEGMat in _openmeeg:
_openmeeg.SurfSource2MEGMat_swigregister(SurfSource2MEGMat)

class DipSource2MEGMat(Matrix):
    r"""Proxy of C++ OpenMEEG::DipSource2MEGMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, dipoles, sensors):
        r"""__init__(DipSource2MEGMat self, Matrix dipoles, Sensors sensors) -> DipSource2MEGMat"""
...
# Register DipSource2MEGMat in _openmeeg:
_openmeeg.DipSource2MEGMat_swigregister(DipSource2MEGMat)

class DipSource2InternalPotMat(Matrix):
    r"""Proxy of C++ OpenMEEG::DipSource2InternalPotMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(DipSource2InternalPotMat self, Geometry geo, Matrix dipoles, Matrix points, std::string const & domain_name="") -> DipSource2InternalPotMat"""
...
# Register DipSource2InternalPotMat in _openmeeg:
_openmeeg.DipSource2InternalPotMat_swigregister(DipSource2InternalPotMat)

class CorticalMat(Matrix):
    r"""Proxy of C++ OpenMEEG::CorticalMat class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(CorticalMat self, Geometry geo, Head2EEGMat M, std::string const & domain_name="CORTEX", unsigned int const gauss_order=3, double alpha=-1., double beta=-1., std::string const & filename="") -> CorticalMat"""
        _openmeeg.CorticalMat_swiginit(self, _openmeeg.new_CorticalMat(*args))
    __swig_destroy__ = _openmeeg.delete_CorticalMat

# Register CorticalMat in _openmeeg:
_openmeeg.CorticalMat_swigregister(CorticalMat)

class CorticalMat2(Matrix):
    r"""Proxy of C++ OpenMEEG::CorticalMat2 class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(CorticalMat2 self, Geometry geo, Head2EEGMat M, std::string const & domain_name="CORTEX", unsigned int const gauss_order=3, double gamma=1., std::string const & filename="") -> CorticalMat2"""
        _openmeeg.CorticalMat2_swiginit(self, _openmeeg.new_CorticalMat2(*args))
    __swig_destroy__ = _openmeeg.delete_CorticalMat2

# Register CorticalMat2 in _openmeeg:
_openmeeg.CorticalMat2_swigregister(CorticalMat2)
