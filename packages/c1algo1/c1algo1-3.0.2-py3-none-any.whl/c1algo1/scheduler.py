...
from .assign_time_slots import time_slot_assignment
...
def generate_schedule(professors, schedule):
    ...
    assign_fall_times = time_slot_assignment(fall_course_list, profs_associated_with_courses[0], "fall")
    courses_and_timeslots = assign_fall_times.run()
    ...
    assign_spring_times = time_slot_assignment(spring_course_list, courses_and_timeslots, "spring")
    courses_and_timeslots = assign_spring_times.run()
    ...
    assign_summer_times = time_slot_assignment(summer_course_list, courses_and_timeslots, "summer")
    courses_and_timeslots = assign_summer_times.run()
