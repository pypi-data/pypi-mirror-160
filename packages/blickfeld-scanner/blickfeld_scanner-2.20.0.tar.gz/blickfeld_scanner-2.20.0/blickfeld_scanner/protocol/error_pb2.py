...
_ERROR_CONNECTIONABORT = _descriptor.Descriptor(
  ...
  serialized_options=b'\202\246\035\215\001During reading, the connection to the client got aborted. Check the network connectivity or power state of the device.\n\tDetails: {details:%s}',
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
