...
def expr_254(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
MapTreeLeaf_2_reflection = expr_254
...
def expr_255(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
MapTreeNode_2_reflection = expr_255
...
def MapTreeModule_rebalance(t1: Optional[MapTreeLeaf_2[_KEY, _VALUE]], k: _KEY, v: _VALUE, t2: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Optional[MapTreeLeaf_2[_KEY, _VALUE]]:
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value, MapTreeNode_2):
            def arrow_256(t1: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t1, k: _KEY=k, v: _VALUE=v, t2: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t2) -> int:
        ...
        if isinstance(match_value_2, MapTreeNode_2):
            def arrow_257(t1: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t1, k: _KEY=k, v: _VALUE=v, t2: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t2) -> int:
...
def MapTreeModule_partition1(comparer: IComparer[_KEY], f: Any, k: _KEY, v: __A, acc1: Optional[MapTreeLeaf_2[_KEY, __A]]=None, acc2: Optional[MapTreeLeaf_2[_KEY, __A]]=None) -> Tuple[Optional[MapTreeLeaf_2[_KEY, __A]], Optional[MapTreeLeaf_2[_KEY, __A]]]:
    if f(k, v):
...
def MapTreeModule_partitionAux(comparer_mut: IComparer[_KEY], f_mut: Any, m_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]], acc__mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]], acc__1_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]]) -> Tuple[Optional[MapTreeLeaf_2[_KEY, _VALUE]], Optional[MapTreeLeaf_2[_KEY, _VALUE]]]:
    while True:
...
def MapTreeModule_partition(comparer: IComparer[_KEY], f: Any, m: Optional[MapTreeLeaf_2[_KEY, __A]]=None) -> Tuple[Optional[MapTreeLeaf_2[_KEY, __A]], Optional[MapTreeLeaf_2[_KEY, __A]]]:
    return MapTreeModule_partitionAux(comparer, f, m, MapTreeModule_empty(), MapTreeModule_empty())


def MapTreeModule_filter1(comparer: IComparer[_KEY], f: Any, k: _KEY, v: __A, acc: Optional[MapTreeLeaf_2[_KEY, __A]]=None) -> Optional[MapTreeLeaf_2[_KEY, __A]]:
    if f(k, v):
...
def MapTreeModule_filter(comparer: IComparer[_KEY], f: Any, m: Optional[MapTreeLeaf_2[_KEY, __A]]=None) -> Optional[MapTreeLeaf_2[_KEY, __A]]:
...
def MapTreeModule_iter(f: Any, m: Optional[MapTreeLeaf_2[__A, __B]]=None) -> None:
...
def MapTreeModule_tryPick(f: Any, m: Optional[MapTreeLeaf_2[__A, __B]]=None) -> Optional[__C]:
...
def MapTreeModule_exists(f: Any, m: Optional[MapTreeLeaf_2[__A, __B]]=None) -> bool:
...
def MapTreeModule_forall(f: Any, m: Optional[MapTreeLeaf_2[__A, __B]]=None) -> bool:
...
def MapTreeModule_mapi(f: Any, m: Optional[MapTreeLeaf_2[__A, __B]]=None) -> Optional[MapTreeLeaf_2[__A, __C]]:
...
def MapTreeModule_foldBack(f: Any, m: Optional[MapTreeLeaf_2[__A, __B]], x: __C) -> __C:
...
def MapTreeModule_fold(f: Any, x: __A, m: Optional[MapTreeLeaf_2[__B, __C]]=None) -> __A:
    return MapTreeModule_foldOpt(f, x, m)


def MapTreeModule_foldSectionOpt(comparer: IComparer[_KEY], lo: _KEY, hi: _KEY, f: Any, m: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x: __A) -> __A:
    def fold_from_to(f_1_mut: Any, m_1_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x_1_mut: __B, comparer: IComparer[_KEY]=comparer, lo: _KEY=lo, hi: _KEY=hi, f: Any=f, m: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=m, x: __A=x) -> __B:
        while True:
...
def MapTreeModule_foldSection(comparer: IComparer[_KEY], lo: _KEY, hi: _KEY, f: Any, m: Optional[MapTreeLeaf_2[_KEY, __A]], x: __B) -> __B:
...
def MapTreeModule_copyToArray(m: Optional[MapTreeLeaf_2[__A, __B]], arr: Array[Any], i: int) -> None:
    j : int = i or 0
    def arrow_258(x: __A, y: __B, m: Optional[MapTreeLeaf_2[__A, __B]]=m, arr: Array[Any]=arr, i: int=i) -> None:
        nonlocal j
        arr[j] = (x, y)
        j = (j + 1) or 0

    MapTreeModule_iter(arrow_258, m)
...
def MapTreeModule_ofList(comparer: IComparer[__A], l: FSharpList[Tuple[__A, __B]]) -> Optional[MapTreeLeaf_2[__A, __B]]:
    def arrow_259(acc: Optional[MapTreeLeaf_2[__A, __B]], tupled_arg: Tuple[__A, __B], comparer: IComparer[__A]=comparer, l: FSharpList[Tuple[__A, __B]]=l) -> Optional[MapTreeLeaf_2[__A, __B]]:
        return MapTreeModule_add(comparer, tupled_arg[0], tupled_arg[1], acc)

    return fold_1(arrow_259, MapTreeModule_empty(), l)


def MapTreeModule_mkFromEnumerator(comparer_mut: IComparer[__A], acc_mut: Optional[MapTreeLeaf_2[__A, __B]], e_mut: IEnumerator[Tuple[__A, __B]]) -> Optional[MapTreeLeaf_2[__A, __B]]:
    while True:
...
def expr_260(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
MapTreeModule_MapIterator_2_reflection = expr_260
...
def MapTreeModule_notStarted() -> __A:
    raise Exception("enumeration not started")


def MapTreeModule_alreadyFinished() -> __A:
...
def expr_264(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class FSharpMap(Generic[_KEY, _VALUE]):
    ...
    def __str__(self) -> str:
        this : FSharpMap[_KEY, _VALUE] = self
        def arrow_262(kv: Any) -> str:
            return format("({0}, {1})", kv[0], kv[1])

        return ("map [" + join("; ", map_1(arrow_262, this))) + "]"
...
def FSharpMap__TryPick(m: FSharpMap[_KEY, _VALUE], f: Any) -> Optional[__A]:
...
def FSharpMap__Fold(m: FSharpMap[_KEY, _VALUE], f: Any, acc: __A) -> __A:
...
def FSharpMap__ComputeHashCode(this: FSharpMap[_KEY, _VALUE]) -> int:
    ...
    with get_enumerator(this) as enumerator:
        while enumerator.System_Collections_IEnumerator_MoveNext():
            active_pattern_result : Tuple[_KEY, _VALUE] = enumerator.System_Collections_Generic_IEnumerator_00601_get_Current()
...
def is_empty(table: FSharpMap[__A, __B]) -> bool:
...
def contains_key(key: __A, table: FSharpMap[__A, __B]) -> bool:
    return FSharpMap__ContainsKey(table, key)


def iterate(action: Any, table: FSharpMap[__A, __B]) -> None:
    FSharpMap__Iterate(table, action)


def try_pick(chooser: Any, table: FSharpMap[__A, __B]) -> Optional[__C]:
    return FSharpMap__TryPick(table, chooser)


def pick(chooser: Any, table: FSharpMap[__A, __B]) -> __C:
...
def exists(predicate: Any, table: FSharpMap[__A, __B]) -> bool:
    return FSharpMap__Exists(table, predicate)


def filter(predicate: Any, table: FSharpMap[__A, __B]) -> FSharpMap[__A, __B]:
    return FSharpMap__Filter(table, predicate)


def partition(predicate: Any, table: FSharpMap[__A, __B]) -> Tuple[FSharpMap[__A, __B], FSharpMap[__A, __B]]:
    return FSharpMap__Partition(table, predicate)


def for_all(predicate: Any, table: FSharpMap[__A, __B]) -> bool:
    return FSharpMap__ForAll(table, predicate)


def map(mapping: Any, table: FSharpMap[__A, __B]) -> FSharpMap[__A, __C]:
...
def find_key(predicate: Any, table: FSharpMap[__A, __B]) -> __A:
    def chooser(kvp: Any, predicate: Any=predicate, table: FSharpMap[__A, __B]=table) -> Optional[__A]:
        k : __A = kvp[0]
...
def try_find_key(predicate: Any, table: FSharpMap[__A, __B]) -> Optional[__A]:
    def chooser(kvp: Any, predicate: Any=predicate, table: FSharpMap[__A, __B]=table) -> Optional[__A]:
        k : __A = kvp[0]
        if predicate(k, kvp[1]):
            return some(k)
...
def count(table: FSharpMap[__A, __B]) -> int:
