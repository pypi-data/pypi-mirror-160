...
EqualityComparer_1_reflection = expr_13
...
def EqualityComparer_1_get_Default() -> IEqualityComparer[Any]:
    class ObjectExpr14(IEqualityComparer[Any]):
...
class Stack_1(Generic[_T]):
    ...
    def GetEnumerator(self) -> IEnumerator[_T]:
        _ : Stack_1[_T] = self
        def arrow_18(__unit: Any=None) -> IEnumerable[_T]:
            index : int = (_.count - 1) or 0
            def arrow_15(__unit: Any=None) -> bool:
                return index >= 0
            ...
            def arrow_17(__unit: Any=None) -> IEnumerable[_T]:
                ...
                return append(singleton(_.contents[index]), delay(arrow_16))

            return enumerate_while(arrow_15, delay(arrow_17))

        return get_enumerator(delay(arrow_18))
