...
def get_files(search_path=False, **kwargs):
    ...
    dicts = _obj.get_kwarg(['dicts'], True, bool, **kwargs)
...
class GetFilesThreaded:
    ...
    def __init__(self, search_path, **kwargs):
        ...
        self.dicts = _obj.get_kwarg(['dicts'], True, bool, **kwargs)
    ...
    def _get_data_thread(self, file_path):
        ...
        if self.dicts is False:
            file_data = _f.File(file_path,file_data)
