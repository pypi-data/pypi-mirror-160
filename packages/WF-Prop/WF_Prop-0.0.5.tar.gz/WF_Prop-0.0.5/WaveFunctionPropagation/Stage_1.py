...
class Stage_1:
    ...
    def __init__(self, locpot_vec, E0, sigma, z_original=None, Max_z_iterations=10,
        ...
        locpot_vec : `numpy.ndarray`, (N,2)
                This is a 2 column matrix. The first colmn is ``z``, the spatial coordinates vector and second is ``v``, the local potential vector.
        E0 : float
        ...
        z_original : np.array, array_like, optional, default: None
                The original, initial spatial coordinates vector.
        Max_z_iterations : int, optional, default: 10
                The maximum number of the iterations that the loop will be going through until convergence of the drid density.
        Noriginal : int, optional, default: None
                The initial/ original number of spatial steps, the number of `dx`'s in the spatial coordinates vector. If not
                supplied, it will take the value of ``len(z_original)``
        allmin : `numpy.ndarray`, (N,2), default: None
        ...
        allmax : `numpy.ndarray`, (N,2), default: None
    ...
    def initial_wavefunc_energies(self, N=None, Multi = 5):
        ...
        Parameters
        ----------
        N : int/float, optional, default: None
        ...
        Multi : int/float, optional, default: 5
    ...
    def calculate_E0(self, zz, vv, psi0, N=None):
        ...
        N : int, optional, default: None
                The number of spatial steps, the number of `dx`'s.
         '''
        zz = to_column_vec(zz)
        zz = self.cons.A2m(zz)
        vv = to_column_vec(vv)
    ...
    def converge_main_axis_grid(self, tol = 0.001):
        '''
        Converges the spatial grid of the system according to total energy difference of the tol parameter supplied
        ...
        -------
        zz_convg : np.array
                The converged spatial grid vector.
        vv_convg : np.array
                The converged local potential vector.
        psi0_convg : np.array
                The converged wave function values vector.
        grid_density : float
                The converged spatial grid density. It is defined as the number of the spatial points divided by the system length.
        psi0_dic : dict
