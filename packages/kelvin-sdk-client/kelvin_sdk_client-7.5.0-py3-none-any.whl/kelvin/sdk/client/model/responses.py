...
class ACPMetaDataItem(DataModelBase):
    ...
    def list_acp_metadata(
        ...
        **Permission Required:** `kelvin.permission.acp.read`.
        ...
        return result.fetch("GET") if fetch and not _dry_run else result
...
class AssetClass(DataModelBase):
    ...
    created: Optional[datetime] = Field(
        None,
        description='Time of creation of this Kelvin Class in ISO 8601 UTC date/time format. Example; "2022-07-08T08:41:01.657916Z".',
    )
    ...
    name: Optional[str] = Field(
        None,
        description='Unique identifier name of the newly created <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-class" target="_blank">Kelvin Asset Class</a>.',
        max_length=64,
    )
    ...
    title: Optional[str] = Field(
        None,
        description='Display name (title) of the newly created <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-class" target="_blank">Kelvin Asset Class</a>.',
        max_length=64,
    )
    updated: Optional[datetime] = Field(
        None,
        description='Time of modifying any variable of this Kelvin Class in ISO 8601 UTC date/time format. Example; "2022-07-08T08:41:01.657916Z".',
    )
    ...
    def list_asset_class(
        ...
        Returns a filtered list of all <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-class" target="_blank">Kelvin Asset Classes</a> on the Kelvin Platform.

        If no query parameters are given with the API request, then the defaults will be used to return the <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-class" target="_blank">Kelvin Asset Class</a> list. The defaults are the first 20 <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-class" target="_blank">Kelvin Asset Classes</a> returned in alphabetical order by the unique identifier name.
        ...
        **Permission Required:** `kelvin.permission.asset_class.read`.
        ...
        search : :obj:`Sequence[str]`
            ...
            matches as well. For example if a Kelvin Asset Class name is
        ...
        page_size : :obj:`int`
            ...
            size can be between 1 and 1000. The default is 20 Kelvin Asset Class
            objects.
        starting_after : :obj:`str`
        ...
        sort_by : :obj:`str`
            Sort the results by one of the Kelvin Asset Class parameters. Only one
            parameter can be selected.</p> There are six parameter options;
            `asset_class.name`, `asset_class.title`, `asset_class.created`,
            `asset_class.updated`, `asset_class.owner` and
            `asset_class.device_type_name`. The default is `asset_class.name`
        sort_asc : :obj:`bool`
            Sorting order for the results.</p> There are two options; `true`
            (ascending order) and `false` (descending order). The default is true
            (ascending).
        owner : :obj:`str`
            Filter Kelvin Asset Class by owner.</p> There are two types of owners;
            `custom` (any user) or `kelvin` (core kelvin asset class).
    ...
    def get_asset_class(
        ...
        **Permission Required:** `kelvin.permission.asset_class.read`.
        ...
        asset_class_name : :obj:`str`, optional
            <a href='https://docs.kelvininc.com/latest/kelvin-overview/kelvin-
            platform/kelvin-assets/#asset-class' target='_blank'>Kelvin Asset
            Class </a> name to retrieve.</p> This is the unique identifier name
    ...
    def update_asset_class(
        ...
        **Permission Required:** `kelvin.permission.asset_class.update`.
        ...
        asset_class_name : :obj:`str`, optional
            ...
            platform/kelvin-assets/#asset-class' target='_blank'>Kelvin Asset
            Class </a> name to retrieve.</p> This is the unique identifier name
            and not the display name of the <a
            href='https://docs.kelvininc.com/latest/kelvin-overview/kelvin-
            platform/kelvin-assets/#asset-class' target='_blank'>Kelvin Asset
            Class</a>.
...
class AssetDataStreamItem(DataModelBase):
    ...
    def list_asset_data_streams(
        ...
        _client: Any = None,
        **kwargs: Any,
    ) -> Union[Sequence[AssetDataStreamItem], AssetDataStreamsListPaginated]:
        """
        ...
        **kwargs:
        ...
        return result.fetch("POST") if fetch and not _dry_run else result
...
class AssetDataStreamsListPaginated(PaginatorDataModel[AssetDataStreamItem]):
    ...
    data: Optional[List[AssetDataStreamItem]] = None
    pagination: Optional[pagination.Pagination] = None
...
class AssetType(DataModelBase):
    ...
    title: Optional[str] = Field(
        None,
        description='Display name (title) of the newly created <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-type" target="_blank">Kelvin Asset Type</a>.',
        max_length=64,
    )
    updated: Optional[datetime] = Field(
        None,
    ...
    def list_asset_type(
        ...
        Returns a filtered list of all <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-type" target="_blank">Kelvin Asset Types</a> on the Kelvin Platform.

        If no query parameters are given with the API request, then the defaults will be used to return the <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-type" target="_blank">Kelvin Asset Type</a> list. The defaults are the first 20 <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-type" target="_blank">Kelvin Asset Types</a> returned in alphabetical order by the unique identifier name.
    ...
    def create_asset_type_metadata(
        ...
        **kwargs: Any,
        ...
        When performing a `get` or `list` API request on <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-type" target="_blank">Kelvin Asset Types</a> or <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/" target="_blank">Kelvin Assets</a> then you can also add a metadata parameter to return this custom information for your own use.

        This metadata does not affect the operation of the Kelvin Platform.
        ...
        **Permission Required:** `kelvin.permission.asset_type.create`.
        ...
        asset_type_name : :obj:`str`, optional
            ...
            Type</a> to attach the metadata to.
...
class AssetTypeMetadata(DataModelBase):
    ...
    asset_type_name: Optional[str] = Field(
        None,
        description='Unique identifier name of the <a href="https://docs.kelvininc.com/latest/kelvin-overview/kelvin-platform/kelvin-assets/#asset-type" target="_blank">Kelvin Asset Type</a> that is linked to this new Kelvin Asset Type Metadata.',
    )
    created: Optional[datetime] = Field(
        None,
        description='Time of creation of this Kelvin Asset Type Metadata in ISO 8601 UTC date/time format. Example; "2022-07-08T08:41:01.657916Z".',
    )
    name: Optional[str] = Field(
        None,
        description="Unique identifier name of the newly created Kelvin Asset Type Metadata.",
        max_length=64,
    )
    payload: Optional[Dict[str, Any]] = Field(
        None, description="Custom JSON parameters defined by you."
    )
    updated: Optional[datetime] = Field(
        None,
        description='Time of modifying any variable of this Kelvin Asset Type Metadata in ISO 8601 UTC date/time format. Example; "2022-07-08T08:41:01.657916Z".',
    )
...
class ControlChange(DataModelBase):
    ...
    def get_last_control_change(
        ...
        _client: Any = None,
        **kwargs: Any,
    ) -> Union[Sequence[ControlChangeGet], ControlChangeGetPaginated]:
        """
        Get Last Control Change lists the last Control Changes for each asset metric.
    ...
    def get_range_control_change(
        ...
        **kwargs: Any,
        ...
        """
        Get Range Control Change lists the Control Changes for each asset metric.
    ...
    def download_control_change(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[ControlChange], ControlChangePaginated]:
        """
    ...
    def get_control_change(
        self_or_cls, control_change_id: str, _dry_run: bool = False, _client: Any = None
    ) -> ControlChangeGet:
        """
        Get Control Change
...
class ControlChangePaginated(PaginatorDataModel[ControlChange]):
    ...
    data: Optional[List[ControlChange]] = None
    pagination: Optional[pagination.Pagination] = None
...
class FailureEventItem(DataModelBase):
    ...
    def list_failure_events(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[FailureEventItem], FailureEventPaginated]:
        """
        List Failure Events
...
class InstanceSettingItem(DataModelBase):
    ...
    def list_instance_settings(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[InstanceSettingItem], InstanceSettingListPaginated]:
        """
...
class MapItem(DataModelBase):
    ...
    def create_map(
        ...
        **kwargs:
        ...
        result = self_or_cls._make_request(
            ...
            requests.MapCreate,
            False,
            {"201": MapModel, "400": errors.ErrorMessage, "401": errors.ErrorMessage},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def list_maps(
        ...
        **Pagination Sortable Columns:** `map.name`, `map.title`, `start_date`
    ...
    def list_symbols(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[Symbol], SymbolsListPaginated]:
        """
        List Symbols
        ...
        **Permission Required:** `kelvin.permission.maps.read`.
        ...
        ----------
        search : :obj:`Sequence[str]`
            Search symbols by name or title
        symbol_types : :obj:`Sequence[str]`
            Search symbols by symbol type
        page_size : :obj:`int`
            Number of objects to be returned, between 1 and 1000. Default: 20
        starting_after : :obj:`str`
            Lower bound cursor for use in pagination
...
class SymbolsListPaginated(PaginatorDataModel[Symbol]):
    ...
    data: Optional[List[Symbol]] = None
    pagination: Optional[pagination.Pagination] = None
...
class AssetItem(DataModelBase):
    ...
    def list_asset(
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        names : :obj:`Sequence[str]`
            Filter assets matching a list of names
        ...
        properties_filter : :obj:`Sequence[str]`
            Filter assets that have an property.name = property.value. Format
            `property_name=property_value`
        properties : :obj:`Sequence[str]`
            Only return specific properties (default: return all properties):
    ...
    def get_asset_oee(
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        ----------
        timestamp : :obj:`str`
            Timestamp to search for specific OEE values for a given point in time
            (supports RFC3339 and Unix timestamps with nanosecond precision)
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": AssetOEE, "400": ErrorMessages, "401": ErrorMessages, "404": ErrorMessages},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_asset_shift(
        cls,
        timestamp: Optional[str] = None,
        data: Optional[Union[requests.AssetShiftGet, Mapping[str, Any]]] = None,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> AssetShift:
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        ``getAssetShift``: ``POST`` ``/api/v4/assets/shift/get``

        Parameters
        ----------
        timestamp : :obj:`str`
            Timestamp to search for specific Shift information for a given point
            in time (supports RFC3339 and Unix timestamps with nanosecond
            precision)
        data: requests.AssetShiftGet, optional
        **kwargs:
            Extra parameters for requests.AssetShiftGet
              - asset_names: list
              - timestamp: str
        ...
        result = cls._make_request(
            _client,
            "post",
            "/api/v4/assets/shift/get",
            {},
            {"timestamp": timestamp},
            {},
            {},
            data,
            requests.AssetShiftGet,
            False,
            {"200": AssetShift, "400": ErrorMessages, "401": ErrorMessages, "404": ErrorMessages},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_asset_statistics(
        ...
        _client: Any = None,
        **kwargs: Any,
    ) -> Union[Sequence[AssetStatisticsItem], AssetStatisticsPaginated]:
        """
    ...
    def get_asset_hierarchy(
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        entity_type_depth : :obj:`str`
            Sets the start entity type depth in which the hierarchy is returned.
        asset_type_depth : :obj:`str`
            Sets the start asset type depth in which the hierarchy is returned.
            Only valid when entity_type_depth = group
    ...
    @instance_classmethod
    @DataModelBase.translate({"asset_name": "name"})
    def create_asset_oee(
        self_or_cls,
        asset_name: str,
        data: Optional[Union[requests.AssetOEECreate, Mapping[str, Any]]] = None,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> AssetOEE:
        ...
        **Permission Required:** `kelvin.permission.asset.create`.
        ...
        ``createAssetOEE``: ``POST`` ``/api/v4/assets/{asset_name}/oee/create``

        Parameters
        ----------
        asset_name : :obj:`str`, optional
            Asset name
        data: requests.AssetOEECreate, optional
        **kwargs:
            Extra parameters for requests.AssetOEECreate
              - assets_oee: list
        ...
        result = self_or_cls._make_request(
            _client,
            "post",
            "/api/v4/assets/{asset_name}/oee/create",
            {"asset_name": asset_name},
            {},
            {},
            {},
            data,
            requests.AssetOEECreate,
            False,
            {"200": AssetOEE, "400": ErrorMessages, "401": ErrorMessages, "404": ErrorMessages},
            False,
            _dry_run,
    ...
    @instance_classmethod
    @DataModelBase.translate({"asset_name": "name"})
    def create_asset_shift(
        self_or_cls,
        asset_name: str,
        data: Optional[Union[requests.AssetShiftCreate, Mapping[str, Any]]] = None,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> AssetShift:
        ...
        **Permission Required:** `kelvin.permission.asset.create`.
        ...
        ``createAssetShift``: ``POST`` ``/api/v4/assets/{asset_name}/shift/create``

        Parameters
        ----------
        asset_name : :obj:`str`, optional
            Asset name
        data: requests.AssetShiftCreate, optional
        **kwargs:
            Extra parameters for requests.AssetShiftCreate
              - production_info: str
              - shift_info: str
              - team_info: list
        ...
        result = self_or_cls._make_request(
            _client,
            "post",
            "/api/v4/assets/{asset_name}/shift/create",
            {"asset_name": asset_name},
            {},
            {},
            {},
            data,
            requests.AssetShiftCreate,
            False,
            {"200": AssetShift, "400": ErrorMessages, "401": ErrorMessages, "404": ErrorMessages},
            False,
            _dry_run,
    ...
    @classmethod
    def list_site_hierarchy_overview(
        cls,
        site_name: str,
        page_size: Optional[int] = 1000,
        starting_after: Optional[str] = None,
        ...
        sort_by: Optional[str] = None,
        sort_asc: Optional[bool] = None,
        data: Optional[Union[requests.SiteHierarchyOverview, Mapping[str, Any]]] = None,
        fetch: bool = True,
        _dry_run: bool = False,
        _client: Any = None,
        **kwargs: Any,
    ) -> Union[Sequence[SiteHierarchyOverviewItem], SiteHierarchyOverviewPaginated]:
        """
        List Site Hierarchy Overview

        **Pagination Sortable Columns:** `asset.name`, `asset.title`, `asset.failure_quotient`, `asset_type.title`

        **Permission Required:** `kelvin.permission.asset.read`.

        ``listSiteHierarchyOverview``: ``POST`` ``/api/v4/assets/{site_name}/site-hierarchy-overview/list``

        Parameters
        ----------
        site_name : :obj:`str`, optional
            Site name
        page_size : :obj:`int`
            Number of objects to be returned, between 1 and 1000. Default: 20
        starting_after : :obj:`str`
        ...
        sort_asc : :obj:`bool`
            Order of sorting is Ascending. Possible Values: true/false. Default:
            true
        data: requests.SiteHierarchyOverview, optional
        **kwargs:
            Extra parameters for requests.SiteHierarchyOverview
              - alarm_severities: list
              - asset_names: list
              - asset_type_names: list
              - production_line_names: list
              - search: list
        ...
        result = cls._make_request(
            _client,
            "post",
            "/api/v4/assets/{site_name}/site-hierarchy-overview/list",
            {"site_name": site_name},
            {
                "page_size": page_size,
                "starting_after": starting_after,
            ...
            {},
            data,
            requests.SiteHierarchyOverview,
            False,
            {
                "200": SiteHierarchyOverviewPaginated,
                "400": errors.ErrorMessage,
                "401": errors.ErrorMessage,
                "404": errors.ErrorMessage,
                "412": errors.ErrorMessage,
...
class AssetShift(DataModelBase):
    """
    AssetShift object.
...
class AssetStatisticsItem(DataModelBase):
    ...
    entity_type_name: Optional[str] = None
    entity_type_title: Optional[str] = None
    failure_quotient: Optional[float] = None
    name: Optional[str] = None
...
class AssetStatisticsPaginated(PaginatorDataModel[AssetStatisticsItem]):
    ...
    data: Optional[List[AssetStatisticsItem]] = None
    pagination: Optional[pagination.Pagination] = None
...
class ControlChangeGet(DataModelBase):
    ...
    payload: Optional[Dict[str, Any]] = None
    status_log: Optional[List[ControlChangeGetStatus]] = None
    timestamp: Optional[datetime] = None
    updated: Optional[datetime] = None
    ...
    @classmethod
    def get_control_change(
        cls, control_change_id: str, _dry_run: bool = False, _client: Any = None
    ) -> ControlChangeGet:
        """
        Get Control Change
...
class ControlChangeGetPaginated(PaginatorDataModel[ControlChangeGet]):
    ...
    data: Optional[List[ControlChangeGet]] = None
    pagination: Optional[pagination.Pagination] = None
...
class SiteHierarchyOverviewStatistics(DataModelBase):
    """
    SiteHierarchyOverviewStatistics object.
...
class SiteHierarchyOverviewItem(DataModelBase):
    """
    SiteHierarchyOverviewItem object.
    ...
    production_line_title: Optional[str]
    statistics: Optional[SiteHierarchyOverviewStatistics]
    title: Optional[str]
    ...
    production_line_title: Optional[str] = None
    statistics: Optional[SiteHierarchyOverviewStatistics] = None
    title: Optional[str] = None
...
class SiteHierarchyOverviewPaginated(PaginatorDataModel[SiteHierarchyOverviewItem]):
    """
    SiteHierarchyOverviewPaginated object.

    Parameters
    ----------
    data: Optional[List[SiteHierarchyOverviewItem]]
    pagination: Optional[pagination.Pagination]

    """

    data: Optional[List[SiteHierarchyOverviewItem]] = None
    pagination: Optional[pagination.Pagination] = None
    ...
    def create_thread(
        ...
        **Permission Required:** `kelvin.permission.thread.create`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"201": Thread, "400": errors.ErrorMessage, "401": errors.ErrorMessage},
            False,
            _dry_run,
        )
        return result
    ...
    def list_threads(
        ...
        **Permission Required:** `kelvin.permission.thread.read`.
        ...
        result = self_or_cls._make_request(
            ...
            None,
            False,
            {"200": Thread, "400": errors.ErrorMessage, "401": errors.ErrorMessage},
            False,
            _dry_run,
        )
        return result
    ...
    def update_thread_follow(
        ...
        **Permission Required:** `kelvin.permission.thread.read`.
        ...
        result = self_or_cls._make_request(
            ...
            None,
            False,
            {"200": Thread, "404": errors.ErrorMessage},
            False,
            _dry_run,
        )
        return result
