...
from WeatherUnits import Measurement, auto as autoMeasurement
...
class MeasurementDisplayProperties(Stateful):
	...
	@convertTo.decode
	def convertTo(self, value: str) -> Type[Measurement]:
		return autoMeasurement(value)

	@convertTo.encode
	def convertTo(self, value: Type[Measurement]) -> str:
