...
from PySide2.QtCore import QRectF, Signal, QTimer, Qt, QRect, QEvent, QObject, QPoint, QPointF, QSize, QUrl, QMimeData, QByteArray
from PySide2.QtGui import QPainterPath, QMouseEvent, QPainter, QCursor, QIcon, QPixmapCache, QPixmap, QImage, QTransform, QSurfaceFormat, QScreen, QDesktopServices, QShowEvent, QDrag
...
class InsertMenu(QMenu):
	...
	def mousePressEvent(self, event) -> None:
		...
		if isinstance(item, InsertItemAction):
			item.insert()
