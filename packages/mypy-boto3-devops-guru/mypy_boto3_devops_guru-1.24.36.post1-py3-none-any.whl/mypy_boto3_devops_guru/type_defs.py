...
ListMonitoredResourcesFiltersTypeDef = TypedDict(
    "ListMonitoredResourcesFiltersTypeDef",
    {
        ...
        "ResourceTypeFilters": Sequence[Literal["LOG_GROUPS"]],
    },
)
...
_RequiredListMonitoredResourcesRequestListMonitoredResourcesPaginateTypeDef = TypedDict(
    "_RequiredListMonitoredResourcesRequestListMonitoredResourcesPaginateTypeDef",
    {
        "Filters": ListMonitoredResourcesFiltersTypeDef,
    },
)
_OptionalListMonitoredResourcesRequestListMonitoredResourcesPaginateTypeDef = TypedDict(
    "_OptionalListMonitoredResourcesRequestListMonitoredResourcesPaginateTypeDef",
    {
        "PaginationConfig": PaginatorConfigTypeDef,
    },
    total=False,
...
class ListMonitoredResourcesRequestListMonitoredResourcesPaginateTypeDef(
    _RequiredListMonitoredResourcesRequestListMonitoredResourcesPaginateTypeDef,
    _OptionalListMonitoredResourcesRequestListMonitoredResourcesPaginateTypeDef,
):
    pass
