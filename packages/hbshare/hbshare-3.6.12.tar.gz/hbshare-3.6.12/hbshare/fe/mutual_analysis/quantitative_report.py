...
class QuantitativeReport:
    def __init__(self, file_path, target_fund_code, compare_fund_code_list=[]):
        ...
        self.change_dates = sorted(list(set(self.change_dates)))
    ...
    def get_fund_scale(self):
        ...
        if len(self.compare_fund_name_dic) > 0:
            compare_scale_list = []
    ...
    def get_fund_barra_attribution(self):
        ...
        plt.tight_layout()
        plt.savefig('{0}{1}_barra.png'.format(self.file_path, self.target_fund_code))
    ...
    def get_quantitative_report(self):
        ...
        document.add_heading(text='{0}（{1}）定量分析报告'.format(self.target_fund_name, self.target_fund_code), level=0)
        ...
        document.add_heading(text='1. 基金及基金公司简介', level=2)
        ...
        document.add_picture('{0}{1}_barra.png'.format(self.file_path, self.target_fund_code))
