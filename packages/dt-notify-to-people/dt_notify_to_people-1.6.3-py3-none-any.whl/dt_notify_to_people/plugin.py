...
class DingTalkNotifyPlugin(CorePluginMixin, notify.NotificationPlugin):
    ...
    def _post(self, group, project):
        ...
        payload = f"{payload} > 全部报错: {group.__dict__['_state'].__dict__['fields_cache'].__dict__} \n\n"
        payload = f"{payload} > 全部报错: {group.__dict__['_state'].__dict__['fields_cache'].__dict__['project'].__dict__} \n\n"
