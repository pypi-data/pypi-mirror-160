...
class DingTalkNotifyPlugin(CorePluginMixin, notify.NotificationPlugin):
    ...
    def _post(self, group, project):
        ...
        #
        issue_link = group.group.get_absolute_url(params={"referrer": "dingtalknotify"})
        ...
        payload = f"{payload} > 出现次数: {group.group.times_seen} \n\n"
        ...
        payload = f"{payload} > Hi: {group.__dict__} \n\n"
