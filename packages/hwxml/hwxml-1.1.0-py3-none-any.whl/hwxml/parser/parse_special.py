...
def parse_special(item):
    ...
    if _type == 17:
        ...
        neck_angle = float(item["p8"])
        arm1_angle = float(item["p9"])
        arm2_angle = float(item["p10"])
        elbow1_angle = float(item["p11"])
        elbow2_angle = float(item["p12"])
        leg1_angle = float(item["p13"])
        leg2_angle = float(item["p14"])
        knee1_angle = float(item["p15"])
        knee2_angle = float(item["p16"])
        try:
