...
from leap_model_rebuilder import rebuild_model
...
class ModelParser:
    ...
    def get_keras_model_and_model_graph(self, model_path: Path, model_type: ImportModelTypeEnum,
        ...
        try:
            ...
            if model_type in [ImportModelTypeEnum.H5_TF2, ImportModelTypeEnum.PB_TF2]:
                if model_type == ImportModelTypeEnum.H5_TF2:
