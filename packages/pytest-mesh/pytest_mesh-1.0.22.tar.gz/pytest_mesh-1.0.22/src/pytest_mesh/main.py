...
def mysql(pytestconfig):
    ...
    if 'mysql_server' not in key_list \
        ...
        return None
    mysql = MySqlDB(server=pytestconfig.inicfg["mysql_server"], port=pytestconfig.inicfg["mysql_port"],
                    user=pytestconfig.inicfg["mysql_user"], password=quote_plus(pytestconfig.inicfg["mysql_password"]),
