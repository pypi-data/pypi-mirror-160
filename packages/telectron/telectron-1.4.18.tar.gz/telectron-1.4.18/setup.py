...
class Clean(Command):
    DIST = ["./build", "./dist", "./telectron.egg-info"]
    API = [
        "telectron/errors/exceptions", "telectron/raw/functions", "telectron/raw/types", "telectron/raw/base",
...
class Generate(Command):
    description = "Generate telectron files"
