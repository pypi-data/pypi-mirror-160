...
T = TypeVar("T", bound="CreateProfilesRequest")
...
class CreateProfilesRequest:
    """
    Example:
        {'devices': {'kvm': {'path': '/dev/kvm', 'type': 'unix-char'}}, 'name': 'my-profilename', 'description': 'Some
            description string', 'config': {'limits.memory': '2GB'}}

    Attributes:
        name (Union[Unset, str]):  Example: my-profilename.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_profiles_request.additional_properties = d
        return create_profiles_request
