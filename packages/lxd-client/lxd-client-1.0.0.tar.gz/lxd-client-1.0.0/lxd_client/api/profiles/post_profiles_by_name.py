...
from ...models.create_profiles_by_name_request import CreateProfilesByNameRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CreateProfilesByNameRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (CreateProfilesByNameRequest):  Example: {'name': 'new-name'}.
