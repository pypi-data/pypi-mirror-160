...
from ...models.create_images_fingerprint_export_request import CreateImagesFingerprintExportRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CreateImagesFingerprintExportRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        fingerprint (str):
        json_body (CreateImagesFingerprintExportRequest):  Example: {'aliases': ['alias'],
            'certificate': 'target certificate', 'secret': 'secret', 'target': 'target URL'}.
