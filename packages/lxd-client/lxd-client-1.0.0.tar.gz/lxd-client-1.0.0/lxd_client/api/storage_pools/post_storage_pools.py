...
from ...models.create_storage_pools_request import CreateStoragePoolsRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CreateStoragePoolsRequest,
) -> Dict[str, Any]:
    url = "{}/1.0/storage-pools".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (CreateStoragePoolsRequest):  Example: {'driver': 'zfs', 'name': 'pool1',
            'config': {'size': '10GB'}}.
