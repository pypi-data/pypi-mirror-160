...
from ...models.create_instances_by_name_snapshot_request import CreateInstancesByNameSnapshotRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CreateInstancesByNameSnapshotRequest,
) -> Dict[str, Any]:
    url = "{}/1.0/instances/{name}/snapshots".format(client.base_url, name=name)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (CreateInstancesByNameSnapshotRequest):  Example: {'name': 'my-snapshot',
            'stateful': True}.
