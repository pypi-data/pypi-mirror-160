...
from ...models.update_instances_by_name_state_request import UpdateInstancesByNameStateRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UpdateInstancesByNameStateRequest,
) -> Dict[str, Any]:
    url = "{}/1.0/instances/{name}/state".format(client.base_url, name=name)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (UpdateInstancesByNameStateRequest):  Example: {'action': 'stop', 'force': True,
            'timeout': 30, 'stateful': True}.
