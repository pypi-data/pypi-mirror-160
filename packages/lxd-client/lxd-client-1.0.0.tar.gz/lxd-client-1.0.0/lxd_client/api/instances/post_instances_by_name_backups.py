...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CreateInstancesByNameBackupsRequest,
) -> Dict[str, Any]:
    url = "{}/1.0/instances/{name}/backups".format(client.base_url, name=name)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (CreateInstancesByNameBackupsRequest):  Example: {'instance_only': True,
            'optimized_storage': True, 'name': 'backupName', 'expiry': 3600}.
