...
from ...models.patch_networks_by_name_request import PatchNetworksByNameRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchNetworksByNameRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (PatchNetworksByNameRequest):  Example: {'config': {'dns.mode': 'dynamic'}}.
