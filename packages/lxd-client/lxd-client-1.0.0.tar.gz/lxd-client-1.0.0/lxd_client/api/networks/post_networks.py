...
from ...models.create_networks_request import CreateNetworksRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CreateNetworksRequest,
) -> Dict[str, Any]:
    url = "{}/1.0/networks".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (CreateNetworksRequest):  Example: {'name': 'my-network', 'description': 'My
            network', 'config': {'ipv4.address': 'none', 'ipv6.nat': 'true', 'ipv6.address':
