...
from ...models.update_projects_by_name_request import UpdateProjectsByNameRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UpdateProjectsByNameRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (UpdateProjectsByNameRequest):  Example: {'description': 'Some description
            string', 'config': {'features.images': 'true', 'features.profiles': 'true'}}.
