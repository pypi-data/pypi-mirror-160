...
from ...models.create_profiles_request import CreateProfilesRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CreateProfilesRequest,
) -> Dict[str, Any]:
    url = "{}/1.0/profiles".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (CreateProfilesRequest):  Example: {'devices': {'kvm': {'path': '/dev/kvm',
            'type': 'unix-char'}}, 'name': 'my-profilename', 'description': 'Some description string',
