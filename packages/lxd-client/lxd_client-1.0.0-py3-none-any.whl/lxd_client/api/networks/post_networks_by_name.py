...
from ...models.create_networks_by_name_request import CreateNetworksByNameRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CreateNetworksByNameRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (CreateNetworksByNameRequest):  Example: {'name': 'new-name'}.
