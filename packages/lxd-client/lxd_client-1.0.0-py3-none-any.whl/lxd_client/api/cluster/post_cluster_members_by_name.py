...
from ...models.update_cluster_members_by_name_request import UpdateClusterMembersByNameRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UpdateClusterMembersByNameRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (UpdateClusterMembersByNameRequest):  Example: {'server_name': 'node1'}.
