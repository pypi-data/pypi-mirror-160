...
from ...models.update_fingerprint_request import UpdateFingerprintRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UpdateFingerprintRequest,
) -> Dict[str, Any]:
    url = "{}/1.0/certificates/{fingerprint}".format(client.base_url, fingerprint=fingerprint)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        fingerprint (str):
        json_body (UpdateFingerprintRequest):  Example: {'name': 'foo', 'type': 'client'}.
