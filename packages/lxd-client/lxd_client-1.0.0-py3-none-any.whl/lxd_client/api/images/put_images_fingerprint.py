...
from ...models.update_images_fingerprint_request import UpdateImagesFingerprintRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UpdateImagesFingerprintRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        fingerprint (str):
        json_body (UpdateImagesFingerprintRequest):  Example: {'auto_update': True, 'public':
            True, 'properties': {'os': 'ubuntu', 'release': 'bionic', 'description': 'Ubuntu 18.04 LTS
            server (20180601)', 'architecture': 'x86_64'}}.
