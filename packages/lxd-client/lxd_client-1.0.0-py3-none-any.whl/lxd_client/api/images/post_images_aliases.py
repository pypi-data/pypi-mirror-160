...
from ...models.create_images_aliases_request import CreateImagesAliasesRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CreateImagesAliasesRequest,
) -> Dict[str, Any]:
    url = "{}/1.0/images/aliases".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (CreateImagesAliasesRequest):  Example: {'name': 'alias-name', 'description':
            'The alias description', 'target': 'SHA-256'}.
