...
from ...models.create_images_aliases_by_name_request import CreateImagesAliasesByNameRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CreateImagesAliasesByNameRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (CreateImagesAliasesByNameRequest):  Example: {'name': 'new-name'}.
