...
from ...models.update_storage_pools_by_name_volumes_by_type_name_snapshots_name_request import (
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UpdateStoragePoolsByNameVolumesByTypeNameSnapshotsNameRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (str):
        name (str):
        json_body (UpdateStoragePoolsByNameVolumesByTypeNameSnapshotsNameRequest):  Example:
