...
from ...models.update_instances_by_name_snapshots_information_request import (
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UpdateInstancesByNameSnapshotsInformationRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        snapshot_name (str):
        json_body (UpdateInstancesByNameSnapshotsInformationRequest):  Example: {'expires_at':
            '2019-01-16T10:34:56.000Z'}.
