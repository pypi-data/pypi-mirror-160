...
from ...models.patch_instances_by_name_request import PatchInstancesByNameRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: PatchInstancesByNameRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        json_body (PatchInstancesByNameRequest):  Example: {'devices': {'root': {'path': '/',
            'size': '5GB', 'pool': 'default'}}, 'ephemeral': True, 'config': {'limits.cpu': '3'}}.
