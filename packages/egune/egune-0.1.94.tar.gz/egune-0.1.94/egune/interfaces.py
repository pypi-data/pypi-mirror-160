...
class State(Interface):
    ...
    def __init__(
        ...
        self.current_responses = current_responses
    ...
    def apply_response(self, responses):
        self.current_responses = [r.msg.code for r in responses if r.name == "say"]
    ...
    def from_dict(cls, dict):
        return cls(
            ...
            dict["current_responses"] if "current_responses" in dict else None,
