...
function GetOciSubcommands_devops() {
    $ociSubcommands = @{
        ...
        'devops connection' = 'create-bitbucket-cloud-connection create-github-connection create-gitlab-connection delete get list update-bitbucket-cloud-connection update-github-connection update-gitlab-connection'
        ...
        'devops trigger' = 'create-bitbucket-cloud-trigger create-devops-code-repo-trigger create-github-trigger create-gitlab-trigger delete get list update-bitbucket-cloud-trigger update-devops-code-repo-trigger update-github-trigger update-gitlab-trigger'
