...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, description=None, retain_repo_versions=None, versions_href=None, pulp_created=None, name=None, pulp_href=None, pulp_labels=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
