...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, description=None, retain_repo_versions=None, latest_version_href=None, pulp_created=None, versions_href=None, pulp_href=None, name=None, manifest_signing_service=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
