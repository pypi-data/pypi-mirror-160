...
__version__ = "0.10.2"
__latest__ = requests.get("https://capyupdateserver.crykiateams.repl.co/").text
if __latest__ != __version__:
  print(f"Capylang has an update! Version: {__latest__}, update via pip update capylang.")
__functions__ = f'''
...
3. The function then returns the square root of this value.
'''
print(f"Capylang v{__version__}. Made by Anistick. www.anistick.com.")
...
class capy(object):
  ...
  def update():
    ...
    os.system("pip3 install capylang -U")