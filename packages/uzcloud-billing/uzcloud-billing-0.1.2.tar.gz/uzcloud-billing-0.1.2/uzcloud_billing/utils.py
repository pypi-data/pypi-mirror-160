...
class UzcloudBilling(metaclass=Singleton):
    AUTH_URL = settings.UZCLOUD_AUTH_URL
    BILLING_BASE_URL = settings.UZCLOUD_BILLING_BASE_URL
    ...
    def authorize(self):
        response = requests.post(
            ...
            auth=(
                settings.UZCLOUD_BILLING_CLIENT_ID,
                settings.UZCLOUD_BILLING_CLIENT_SECRET,
            ),
            **self.REQUEST_CONFIG,
        )
