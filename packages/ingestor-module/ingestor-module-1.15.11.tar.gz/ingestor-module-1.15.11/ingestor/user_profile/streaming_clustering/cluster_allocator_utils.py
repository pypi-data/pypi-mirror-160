...
from ingestor.common import ASSIGN_CLUSTER_FEATURES, PAYTVPROVIDER_ID, GENDER, AGE, GENDER_MAP, CLUSTER_NODE_LABEL, \
    ...
    CLUSTER_IS_PAY_TV, UPDATED_ON, CREATED_ON, PREVIOUS_CLUSTER_ID, PREVIOUS_TO_PREVIOUS_CLUSTER_ID
...
class ClusterAllocatorUtils:
    ...
    def preprocess_user_attributes(
        ...
        user_paytv = users[users[PAYTVPROVIDER_ID] != -1]
        user_no_paytv = users[users[PAYTVPROVIDER_ID] == -1]
        user_no_paytv_label = user_no_paytv[(user_no_paytv[GENDER] == -1) & (user_no_paytv[PAYTVPROVIDER_ID] == -1)]
        user_no_paytv_label[CLUSTER_NODE_LABEL] = DEFAULT_CLUSTER_LABEL
        user_no_paytv_nlabel = user_no_paytv[~((user_no_paytv[GENDER] == -1) & (user_no_paytv[PAYTVPROVIDER_ID] == -1))]
        user_no_paytv = concat([user_no_paytv_label, user_no_paytv_nlabel], axis=0)
        user_paytv[PAYTVPROVIDER_ID] = user_paytv[PAYTVPROVIDER_ID].apply(lambda x: x[0][PAYTVPROVIDER_ID])
