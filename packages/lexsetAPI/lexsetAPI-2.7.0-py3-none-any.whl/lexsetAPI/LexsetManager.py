...
def addRules(id,fileNames,filePaths,userToken):
    url = "http://lexsetapi.lexset.ai/api/UserDataManagement/uploaduserfile"
    ...
    files=[('files',(fileNames,open(str(filePaths)+str(fileNames),'rb'),'application/yaml'))]
