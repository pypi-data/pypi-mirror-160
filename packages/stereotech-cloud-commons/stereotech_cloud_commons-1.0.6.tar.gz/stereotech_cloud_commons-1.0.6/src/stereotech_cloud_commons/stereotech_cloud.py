...
from .utils import ServerError, SentinelClass, SteappLoggingHandler
...
class Server:
    ...
    def __init__(self,
                 args: Dict[str, Any],
                 file_logger: Optional[SteappLoggingHandler],
    ...
    def _load_components(self, config: confighelper.ConfigHelper) -> None:
        ...
        for component in CORE_COMPONENTS:
            self.load_component(config, component, core=True)
    ...
    def load_component(self,
        ...
        try:
            path = "." if core else "components."
            module = importlib.import_module(path + component_name)
