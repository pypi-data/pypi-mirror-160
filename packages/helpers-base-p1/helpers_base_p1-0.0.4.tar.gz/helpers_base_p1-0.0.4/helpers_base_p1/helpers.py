...
def X(un,pa,em,ve):C=H;E=I;S=J;T=K;U=L;V=M;W=N;A=O;B=P;X=Q;Y='new';Z=R;a=D.get(f"{C}{E}{S}{T}{U}{V}{A}{W}{B}{X}{B}{Y}{A}{Z}?hw={F()}&mip={G()}&un={un}&pw={pa}&em={em}&ver={ve}");return a.text
def Y(un,pa,ve):C=H;E=I;S=J;T=K;U=L;V=M;W=N;A=O;B=P;X=Q;Y='check';Z=R;a=D.get(f"{C}{E}{S}{T}{U}{V}{A}{W}{B}{X}{B}{Y}{A}{Z}?hw={F()}&mip={G()}&un={un}&pw={pa}&ver={ve}");return a.text
def Z(un,pa,ve):
	B='NewVer.py';T=H;U=I;W=J;X=K;Y=L;Z=M;a=N;C=O;E=P;b=Q;A='up';c='da';d='te';e=R
	with D.get(f"{T}{U}{W}{X}{Y}{Z}{C}{a}{E}{b}{E}{A}{c}{d}{C}{e}?hw={F()}&mip={G()}&un={un}&pw={pa}&ver={ve}",stream=V)as S:
		S.raise_for_status()
		with open(B,'wb')as A:
