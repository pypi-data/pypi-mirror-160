import copy
import os
from flowui.scripts.docker_compose_scripts import init_script
...
# FlowUI backend service - for internal development
flowui_backend_dev = {
    "build": {
...
# FlowUI Frontend service - for internal development
flowui_frontend_dev = {
    "build": {
