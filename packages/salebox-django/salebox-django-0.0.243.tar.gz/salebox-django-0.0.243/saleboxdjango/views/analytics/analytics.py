            ...
            if row is None:
                ...
                if ua_string is not None:
                    ...
                    row = Analytic(
                        ...
                        ip_lat=ip_lat,
                        ip_lng=ip_lng,
                        ua_browser_family=ua.browser.family[:32]
                        if ua.browser.family
                        else None,
                        ua_browser_version=ua.browser.version_string[:20]
                        if ua.browser.version_string
                        else None,
                        ua_os_family=ua.os.family[:20] if ua.os.family else None,
                        ua_os_version=ua.os.version_string[:20]
                        if ua.os.version
                        else None,
                        ua_device_family=ua.device.family[:32]
                        if ua.device.family
                        else None,
                        ua_device_brand=ua.device.brand[:20]
                        if ua.device.brand
                        else None,
                        ua_device_model=ua.device.model[:20]
                        if ua.device.model
                        else None,
