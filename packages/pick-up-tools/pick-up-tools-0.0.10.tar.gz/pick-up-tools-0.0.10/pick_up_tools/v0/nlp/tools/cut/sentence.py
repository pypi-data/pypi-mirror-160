...
def cut_sentence_resp(text, min_length=2):
    _text = re.split(r'[\！\？\｡\。\～\r\n ][\」\﹂\”\』\’\》\）\］\｝\〕\〗\〙\〛\〉\】]*', text)
    _text = [i for i in _text if (len(i) >= min_length and i and has_chinese(i))]
    return _text
...
if __name__ == '__main__':
    ...
    健健康康是多么的重要。</p><p></p>
    """
    example = """#新周末和坦克去旅行 #坦克路书征途开启 #坦克300 雨后穿越安顶山～ 1992-1283-898。10月9日坦克开启路途10km挑战。"""
