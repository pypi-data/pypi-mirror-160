...
class CurriculumSchedulerOneMachine():
	...
	def update(self, success):
        ...
        pair_index = random.randint(0,len(self.yaml_data[current_task]['pairs'])) # change goal
		start_goal_pair = self.yaml_data[current_task]['pairs'][random.randint(0,len(self.yaml_data[current_task]['pairs']))]
