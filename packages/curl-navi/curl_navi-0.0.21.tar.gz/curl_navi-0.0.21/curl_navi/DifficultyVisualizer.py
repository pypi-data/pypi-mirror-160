...
__all__ = ['DifficultyMetrics', 'read_ply', 'plot_metric', 'plot_trajectory', 'avg_distance', 'plot_metric_map',
           'plot_trajectory', 'load_csv', 'plot_trajectory']
...
# Cell
def plot_metric_map(data_root, env, folder, filename):
    map_path = data_root + '/' + env + '/' + folder + '/' + filename
    load_obstacle_map = np.load(map_path)
    total_obstacle_map = load_obstacle_map

    fig, ax = plt.subplots()
    barrr = ax.imshow(total_obstacle_map,cmap="binary", interpolation='nearest')
