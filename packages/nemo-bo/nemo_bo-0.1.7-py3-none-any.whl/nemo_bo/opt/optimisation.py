...
class Optimisation:
    ...
    def run(
        ...
        **kwargs,
        ...
        Use this function to start the Bayesian optimisation, including model fitting
    ...
    def find_candidates(
        ...
        **kwargs,
        ...
        if isinstance(self.sampler, PoolBased):
            ...
            # If a fitted benchmark function is provided, use it to predict the outcome of the suggested X array
    ...
    def plot_hypervolume(self, Y: np.ndarray, number_opt_iterations: int) -> None:
        ...
        output_file = os.path.join(
            os.getcwd(),
            rf"Hypervolume vs. Iteration {datetime.now().strftime('%d-%m-%Y, %H-%M-%S')}.png",
        )
