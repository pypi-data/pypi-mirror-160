...
class JupyterLabArgs(PhidataAppArgs):
    ...
    use_workspace_as_root: Optional[bool] = False
...
class JupyterLab(PhidataApp):
        ...
        **extra_kwargs,
        ...
        try:
            self.args: JupyterLabArgs = JupyterLabArgs(
                ...
                use_workspace_as_root=use_workspace_as_root,
    ...
    def get_docker_rg(
        ...
        if (
            self.args.use_workspace_as_root
    ...
    def get_k8s_rg(
        ...
        # if (
        #     self.args.use_workspace_as_root is not None
