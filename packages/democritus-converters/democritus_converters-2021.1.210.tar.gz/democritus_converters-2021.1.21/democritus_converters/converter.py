...
def convert(quantity: Union[int, float], starting_unit: str, converted_unit: str):
    ...
    if not _pint_is_valid_unit(starting_unit):
        print(
            f'The given starting_unit ("{starting_unit}") is not a recognized unit. See https://github.com/hgrecco/pint/blob/master/pint/default_en.txt for a list of units and recognized abbreviations/symbols.'
        )
        raise pint.UndefinedUnitError(starting_unit)
    elif not _pint_is_valid_unit(converted_unit):
        print(
            f'The given converted_unit ("{converted_unit}") is not a recognized unit. See https://github.com/hgrecco/pint/blob/master/pint/default_en.txt for a list of units and recognized abbreviations/symbols.'
        )
