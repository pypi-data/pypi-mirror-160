...
[boto3.ChimeSDKMediaPipelines 1.24.36](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/chime-sdk-media-pipelines.html#ChimeSDKMediaPipelines)
...
def get_structure() -> AudioArtifactsConfigurationTypeDef:
    return {
      ...
    }
```
