...
class DBAgentClient:
    ...
    def create_run(self, *, application_id, node_id, args, input=None, task_id=None):
    ...
    def set_node_up(self, id, *, agent_classname, agent_endpoint, ip=None):
        ...
        resp = self.client.send({
            ...
            "hostname": hostname,
            "ip": ip,
            "agent_classname": agent_classname,
