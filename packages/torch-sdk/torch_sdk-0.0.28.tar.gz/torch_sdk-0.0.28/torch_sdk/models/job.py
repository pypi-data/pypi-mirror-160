...
class Node:
    ...
    def __init__(self, *, asset_uid=None, jobUid=None):
        print(f'asset_uid = {asset_uid}')
        print(f'job_uid = {jobUid}')
        if asset_uid is not None and jobUid is not None:
