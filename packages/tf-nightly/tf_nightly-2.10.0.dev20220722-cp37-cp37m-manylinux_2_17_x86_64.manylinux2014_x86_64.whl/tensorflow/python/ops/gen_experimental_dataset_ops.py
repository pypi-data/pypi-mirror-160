...
def register_dataset_v2(dataset, address, protocol, external_state_policy, element_spec="", metadata="", name=None):
  r"""Registers a dataset with the tf.data service.
...
def register_dataset_v2_eager_fallback(dataset, address, protocol, external_state_policy, element_spec, metadata, name, ctx):
  external_state_policy = _execute.make_int(external_state_policy, "external_state_policy")
  if element_spec is None:
    element_spec = ""
  element_spec = _execute.make_str(element_spec, "element_spec")
