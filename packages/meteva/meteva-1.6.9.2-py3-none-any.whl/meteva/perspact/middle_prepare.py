...
def middle_ds(sta_all,method,grade_list = None,compare = None,gid = None):
    '''
...
if __name__ =="__main__":
    ...
    df_all = middle_ds(sta_all,meteva.method.hfmc,grade_list=[0.1,10,25,50,100,250],gid=id_province)
    print(df_all)
