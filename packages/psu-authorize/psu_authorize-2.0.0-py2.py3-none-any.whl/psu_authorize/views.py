...
def index(request):
    ...
    return render(request, "psu_authorize/index.html", {"allowed_apps": allowed_apps})
...
def app(request, app_code):
    ...
    return render(
        request,
        "psu_authorize/permissions/authorize_app.html",
        {
    ...
    try:
        ...
        if permission_instance:
            ...
            if permission_instance.app_code in allowed_apps:
                ...
                return render(request, "psu_authorize/permissions/_app_permission_rows.html", {})
            else:
                message_service.post_error(
...
def grant(request):
    ...
    try:
        ...
        if app_code in allowed_apps:
            ...
            return render(
                request,
                "psu_authorize/permissions/_app_permission_rows.html",
...
def manage_apps(request):
    ...
    return render(request, "psu_authorize/applications/index.html", {"apps": apps})
    ...
    try:
        ...
        for aa in apps:
            if app_code.upper() == aa.code:
                return render(request, "psu_authorize/applications/_rows.html", {"apps": [aa]})
...
def manage_authorities(request):
    ...
    return render(
        request,
        "psu_authorize/authorities/index.html",
        {
    ...
    try:
        ...
        for auth in authorities:
            if authority_code == auth.code:
                return render(
                    request,
                    "psu_authorize/authorities/_rows.html",
                    {
                        "authorities": [auth],
                        "global_access": authorization_service.can_manage_global(),
                    },
...
def delete_authority(request, authority_id):
    ...
    try:
        ...
        if response == "success":
            ...
            return render(request, "psu_authorize/authorities/_rows.html", {})
        else:
