...
from pulpcore.client.pulp_cookbook.models.policy_enum import PolicyEnum  # noqa: E501
...
class TestPolicyEnum(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_cookbook.models.policy_enum.PolicyEnum()  # noqa: E501
        if include_optional :
            return PolicyEnum(
            )
        else :
