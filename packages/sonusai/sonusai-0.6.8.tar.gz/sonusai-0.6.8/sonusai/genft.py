...
def genft(mixdb: MixtureDatabase,
    ...
    mp_feature = multiprocessing.Array(ctypes.c_float, total_feature_frames * fg.stride * fg.num_bands)
    mp_truth_f = multiprocessing.Array(ctypes.c_float, total_feature_frames * fg.num_classes)
    if compute_segsnr:
        mp_segsnr = multiprocessing.Array(ctypes.c_float, total_transform_frames)
    else:
