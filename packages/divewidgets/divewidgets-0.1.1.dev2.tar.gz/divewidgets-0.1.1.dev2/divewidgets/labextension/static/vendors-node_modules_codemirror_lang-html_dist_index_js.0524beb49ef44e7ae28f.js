"use strict";
(self["webpackChunkjupyter_divewidgets"] = self["webpackChunkjupyter_divewidgets"] || []).push([["vendors-node_modules_codemirror_lang-html_dist_index_js"],{
...
/* harmony import */ var _codemirror_lang_javascript__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @codemirror/lang-javascript */ "webpack/sharing/consume/default/@codemirror/lang-javascript/@codemirror/lang-javascript?9a03");
...
function htmlCompletionFor(schema, context) {
    let { state, pos } = context, around = (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.syntaxTree)(state).resolveInner(pos), tree = around.resolve(pos, -1);
...
`<style>` tags.
*/
const htmlLanguage = /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.LRLanguage.define({
...
const autoCloseTags = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_4__.EditorView.inputHandler.of((view, from, to, text) => {
    ...
    let changes = state.changeByRange(range => {
        var _a, _b, _c;
        let { head } = range, around = (0,_codemirror_language__WEBPACK_IMPORTED_MODULE_2__.syntaxTree)(state).resolveInner(head, -1), name;
...
//# sourceMappingURL=vendors-node_modules_codemirror_lang-html_dist_index_js.0524beb49ef44e7ae28f.js.map