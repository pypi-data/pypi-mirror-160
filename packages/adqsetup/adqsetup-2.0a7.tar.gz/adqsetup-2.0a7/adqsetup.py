...
class TCtool(object):
                    ...
                    if attr.type == TCAttr.TYPE_KIND:
                        ...
                        if TCFLAttr.TYPE_ACT in attrs:
                            ...
                            if actions[TCAttr.TYPE_KIND] == "skbedit":
                                ...
                                # print(options[TCSKBAttr.TYPE_PARMS])
    ...
    def filter_add(self, direction='ingress', prio=1, proto='tcp', 
        ...
        with RNLConn() as conn:
            ...
            msg = NLMessage(
                ...
                flags=NLMessage.NLM_F_REQUEST | NLMessage.NLM_F_ACK | 
                    NLMessage.NLM_F_EXCL | NLMessage.NLM_F_CREATE, 
                data=self.TCmsg(
            ...
            if self.log:
                ...
                self.log.write("+ tc filter add dev %s %s\n" % 
    ...
    def filter_del(self, direction='ingress'):
        ...
        with RNLConn() as conn:
            ...
            conn.sendmsg(msg)
            if self.log:
                self.log.write("+ tc filter del dev %s %s\n" % (self.ifname, direction))
        ...
        if self._filters:
            ...
            for f in filters['ingress']:
                ...
                for n, v in f._asdict().items():
                    if v is not None:
                        params.append("%s %s" % (n.replace('tc', 'hw_tc'), str(v)))
