...
class BaseFactory:
    ...
    def __init__(self, validator: BaseValidator | None = None, default=Undefined):
    ...
    def __call__(self, data, key: str) -> Tuple[Any, str | None]:
        ...
        field = get_value(data, key, Undefined)
        value = self._default if field is Undefined else field
...
class BaseField:
    ...
    def __init__(self, factory: FactoryType = BaseFactory(), default=Undefined, name=None):
        self.name = name

        self.factory = factory

    def __call__(self, data, key) -> Tuple[Any, str | None]:
        value, custom_name = self.factory(data, key)

        return value, (self.name or custom_name)
...
class Field(BaseField):
    ...
    def __init__(
        ...
        **kwargs
        ...
        custom_factory = factory if factory else BaseFactory(validator=validator or NoopValidator(), default=default)
        ...
        if is_required:
            custom_factory.validator &= IsRequired(not_blank=default is not Undefined)
