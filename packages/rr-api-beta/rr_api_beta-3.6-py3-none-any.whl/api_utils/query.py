...
class Ranking:
    ...
    def players_ranking(data_type: int, object_id: int = None):
        main_query = "select distinct rp.rankset_id, rp.rankset_name, rpr.tour_name, cast(rpr.player_rank as decimal (10,2)) as avg_rank, rpr.season, rpm.age, rpm.place_of_birth," \
        ...
        end_query = " and rpr.player_rank group by rp.rankset_id, rp.rankset_name, rpr.tour_name, rpr.player_rank, rpr.season, rpm.age,rpm.place_of_birth, rpm.mv, rpm.mv_type order by avg_rank, season desc;"
        match data_type:
            case 1:
