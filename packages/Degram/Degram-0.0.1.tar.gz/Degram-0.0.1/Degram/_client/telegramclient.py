...
class TelegramClient:
    """
    Arguments
        session (`str` | `Degram.sessions.abstract.Session`, `None`):
        ...
        connection (`str`, optional):
            ...
            * ``'http'``
            ...
            Defaults to `Degram.network.connection.tcpfull.ConnectionTcpFull`.
        ...
        raise_last_call_error (`bool`, optional):
            When API calls fail in a way that causes Degram to retry
        ...
        app_version (`str`, optional):
            ...
            Defaults to `Degram.version.__version__`.
    ...
    def begin_takeout(
        ...
        <Degram.client.messages.MessageMethods.get_messages>`.
        ...
        .. code-block:: python
            ...
            Degram.ignore_takeout.set(True)
    ...
    async def edit_2fa(
        ...
        Example
            .. code-block:: python
                ...
                await client.edit_2fa(new_password='I_<3_Degram')

                # Removing the password
                await client.edit_2fa(current_password='I_<3_Degram')
        """
    ...
    async def inline_query(
        ...
        Returns
            ...
            <Degram.tl._custom.inlineresult.InlineResult>`.

        Example
            .. code-block:: python

                # Make an inline query to @like
                results = await client.inline_query('like', 'Do you like Degram?')

                # Send the first result to some chat
                message = await results[0].click('DegramOffTopic')
        """
    ...
    def get_participants(
        ...
        Example
            .. code-block:: python
                ...
                # Filter by admins
                from Degram.tl.types import ChannelParticipantsAdmins
    ...
    def get_admin_log(
        ...
        *all* event types will be returned. If at least one of them is
        ...
        Yields
            Instances of `AdminLogEvent <Degram.tl._custom.adminlogevent.AdminLogEvent>`.
    ...
    async def kick_participant(
        ...
        Returns
            Returns the service `Message <Degram.tl._custom.message.Message>`
    ...
    async def get_permissions(
        ...
        Returns
            A `ParticipantPermissions <Degram.tl._custom.participantpermissions.ParticipantPermissions>`
    ...
    async def get_stats(
        ...
        Raises
            ...
            ``Degram.errors.ChatAdminRequiredError`` will appear.
    ...
    def get_dialogs(
        ...
        Yields
            Instances of `Dialog <Degram.tl._custom.dialog.Dialog>`.
    ...
    def get_drafts(
        ...
        Yields
            Instances of `Draft <Degram.tl._custom.draft.Draft>`.
    ...
    async def delete_dialog(
        ...
        See also `Dialog.delete() <Degram.tl._custom.dialog.Dialog.delete>`.
    ...
    async def download_media(
        ...
        See also `Message.download_media() <Degram.tl._custom.message.Message.download_media>`.
    ...
    def get_messages(
        ...
        Arguments
            ...
            reply_to (`int`, optional):
                ...
                will result in ``Degram.errors.PeerIdInvalidError`` to occur.
        ...
        Yields
            Instances of `Message <Degram.tl._custom.message.Message>`.
        ...
        Example
            .. code-block:: python
                ...
                from Degram.tl.types import InputMessagesFilterPhotos
    ...
    async def send_message(
        ...
        See also `Message.respond() <Degram.tl._custom.message.Message.respond>`
        and `Message.reply() <Degram.tl._custom.message.Message.reply>`.

        Arguments
            dialog (`entity`):
                To who will it be sent.

            message (`str` | `Message <Degram.tl._custom.message.Message>`):
            ...
            reply_to (`int` | `Message <Degram.tl._custom.message.Message>`, optional):
            ...
            parse_mode (`object`, optional):
                ...
                <Degram.client.messageparse.MessageParseMethods.parse_mode>`
            ...
            buttons (`list`, `_custom.Button <Degram.tl._custom.button.Button>`, :tl:`KeyboardButton`):
            ...
            comment_to (`int` | `Message <Degram.tl._custom.message.Message>`, optional):
                Similar to ``reply_to``, but replies in the linked group of a
                broadcast channel instead (effectively leaving a "comment to"
                the specified message).

                This parameter takes precedence over ``reply_to``. If there is
                no linked chat, `Degram.errors.sgIdInvalidError` is raised.

        Returns
            The sent `_custom.Message <Degram.tl._custom.message.Message>`.
        ...
        Example
            .. code-block:: python
                ...
                from Degram.types import Message
                ...
                from Degram import events, Button
    ...
    async def forward_messages(
        ...
        See also `Message.forward_to() <Degram.tl._custom.message.Message.forward_to>`.
        ...
        Returns
            The list of forwarded `Message <Degram.tl._custom.message.Message>`,
    ...
    async def edit_message(
        ...
        See also `Message.edit() <Degram.tl._custom.message.Message.edit>`.

        Arguments
            dialog (`entity` | `Message <Degram.tl._custom.message.Message>`):
            ...
            message (`int` | `Message <Degram.tl._custom.message.Message>` | `str`):
                The ID of the message (or `Message
                <Degram.tl._custom.message.Message>` itself) to be edited.
                If the `dialog` was a `Message
                <Degram.tl._custom.message.Message>`, then this message
                will be treated as the new text.

            text (`str`, optional):
                The new text of the message. Does nothing if the `dialog`
                was a `Message <Degram.tl._custom.message.Message>`.
        ...
        Returns
            The edited `Message <Degram.tl._custom.message.Message>`,
    ...
    async def delete_messages(
        ...
        See also `Message.delete() <Degram.tl._custom.message.Message.delete>`.
    ...
    async def mark_read(
        ...
        See also `Message.mark_read() <Degram.tl._custom.message.Message.mark_read>`.

        Arguments
            dialog (`entity`):
                The chat where these messages are located.

            message (`Message <Degram.tl._custom.message.Message>`):
    ...
    async def pin_message(
        ...
        See also `Message.pin() <Degram.tl._custom.message.Message.pin>`.

        Arguments
            dialog (`entity`):
                The chat where the message should be pinned.

            message (`int` | `Message <Degram.tl._custom.message.Message>`):
    ...
    async def unpin_message(
        ...
        See also `Message.unpin() <Degram.tl._custom.message.Message.unpin>`.
    ...
    async def connect(self: 'TelegramClient') -> None:
        ...
        .. note::
            ...
            request, like `client.get_me() <Degram.client.users.UserMethods.get_me>`,
    ...
    def run_until_disconnected(self: 'TelegramClient'):
        ...
        <Degram.client.telegrambaseclient.TelegramBaseClient.disconnect>`
    ...
    def on(self: 'TelegramClient', *events, priority=0, **filters):
        ...
        Example
            .. code-block:: python
                ...
                from Degram import TelegramClient, events
    ...
    def add_event_handler(
        ...
        Arguments
            ...
            event (`_EventBuilder` | `type`, optional):
                ...
                used in the handler, or be `Degram.events.raw.Raw` (the
    ...
    async def send_file(
        ...
        Arguments
            ...
            reply_to (`int` | `Message <Degram.tl._custom.message.Message>`):
        ...
        Returns
            The `Message <Degram.tl._custom.message.Message>` (or messages)
    ...
    async def __call__(self: 'TelegramClient', request, ordered=False, flood_sleep_threshold=None):
        ...
        Args:
            ...
            flood_sleep_threshold (`int` | `None`, optional):
                ...
                `client.flood_sleep_threshold <Degram.client.telegrambaseclient.TelegramBaseClient.flood_sleep_threshold>`
    ...
    async def get_profile(
        ...
        """
        Turns the given profile reference into a `User <Degram.types._custom.user.User>`
        or `Chat <Degram.types._custom.chat.Chat>` instance.
        ...
        Returns
            `User <Degram.types._custom.user.User>` or `Chat <Degram.types._custom.chat.Chat>`,
            depending on the profile requested.

        Example
            .. code-block:: python

                from Degram import utils
