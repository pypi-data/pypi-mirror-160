...
class UserUpdate(EventBuilder, _custom.chatgetter.ChatGetter, _custom.sendergetter.SenderGetter):
    ...
    @property
    def user(self):
        """Alias for `sender <Degram.tl.custom.sendergetter.SenderGetter.sender>`."""
        return self.sender

    async def get_user(self):
        """Alias for `get_sender <Degram.tl.custom.sendergetter.SenderGetter.get_sender>`."""
        return await self.get_sender()

    @property
    def input_user(self):
        """Alias for `input_sender <Degram.tl.custom.sendergetter.SenderGetter.input_sender>`."""
        return self.input_sender

    @property
    def user_id(self):
        """Alias for `sender_id <Degram.tl.custom.sendergetter.SenderGetter.sender_id>`."""
