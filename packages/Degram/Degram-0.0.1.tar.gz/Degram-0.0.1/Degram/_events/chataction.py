...
class ChatAction(EventBuilder):
    ...
    * Whenever a user is removed or leaves a group if it has
    ...
    Members:
        action_message  (`MessageAction <https://tl.Degram.dev/types/message_action.html>`_):
    ...
    async def get_pinned_message(self):
        ...
        <Degram.tl.custom.message.Message>` object that was pinned.
        """
    ...
    async def get_pinned_messages(self):
        ...
        <Degram.tl.custom.message.Message>` objects that were pinned.
        """
