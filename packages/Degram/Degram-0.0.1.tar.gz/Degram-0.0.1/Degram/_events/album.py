...
class Album(EventBuilder, _custom.chatgetter.ChatGetter, _custom.sendergetter.SenderGetter):
    ...
    Members:
        messages (Sequence[`Message <Degram.tl._custom.message.Message>`]):
            The list of messages belonging to the same album.

    Example
        .. code-block:: python

            from Degram import events
    ...
    def forward(self):
        """
        The `Forward <Degram.tl._custom.forward.Forward>`
    ...
    async def get_reply_message(self):
        """
        The `Message <Degram.tl._custom.message.Message>`
    ...
    async def reply(self, *args, **kwargs):
        ...
        for `Degram.client.messages.MessageMethods.send_message`
