...
class MessageEdited(EventBuilder):
    ...
    <Degram.events.newmessage.NewMessage>`, you should treat
    this event as a `Message <Degram.tl.custom.message.Message>`.

    .. warning::

        On channels, `Message.out <Degram.tl.custom.message.Message>`
