...
class CallbackQuery(EventBuilder, _custom.chatgetter.ChatGetter, _custom.sendergetter.SenderGetter):
    ...
    def _build(cls, client, update, entities):
        ...
        if isinstance(update, _tl.UpdateBotCallbackQuery):
            ...
            # See https://github.com/LonamiWebs/Degram/pull/1005
    ...
    async def respond(self, *args, **kwargs):
        ...
        `Degram.client.messages.MessageMethods.send_message` with
        ``entity`` already set.
    ...
    async def edit(self, *args, **kwargs):
        ...
        `Degram.client.messages.MessageMethods.edit_message` with
        ...
        .. note::
            ...
            `Message.edit <Degram.tl._custom.message.Message.edit>`,
