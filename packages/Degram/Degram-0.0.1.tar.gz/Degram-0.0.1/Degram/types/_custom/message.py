...
class Message(ChatGetter, SenderGetter):
    ...
    <Degram.tl.custom.chatgetter.ChatGetter>` and `SenderGetter
    <Degram.tl.custom.sendergetter.SenderGetter>` which means you
    ...
    message = _fwd('message', """
        ...
        <Degram.tl.custom.message.Message>` instances,
    ...
    def client(self):
        """
        Returns the `TelegramClient <Degram.client.telegramclient.TelegramClient>`
    ...
    def forward(self):
        """
        The `Forward <Degram.tl.custom.forward.Forward>`
    ...
    def buttons(self):
        ...
        <Degram.tl.custom.messagebutton.MessageButton>`,
        if any.
    ...
    def file(self):
        """
        Returns a `File <Degram.tl.custom.file.File>` wrapping the
        ...
        `file.id <Degram.tl.custom.file.File.id>`,
        `file.name <Degram.tl.custom.file.File.name>`,
    ...
    def get_entities_text(self, cls=None):
        ...
        Args:
            cls (`type`):
                ...
                >>> from Degram.tl.types import MessageEntityCode
                >>>
                >>> m = ...  # get the message
    ...
    async def respond(self, *args, **kwargs):
        ...
        `Degram.client.messages.MessageMethods.send_message`
    ...
    async def forward_to(self, *args, **kwargs):
        ...
        `Degram.client.messages.MessageMethods.forward_messages`
        ...
        `Degram.client.telegramclient.TelegramClient` instance directly.
        """
    ...
    async def edit(self, *args, **kwargs):
        ...
        `Degram.client.messages.MessageMethods.edit_message`
    ...
    async def delete(self, *args, **kwargs):
        ...
        Shorthand for
        `Degram.client.messages.MessageMethods.delete_messages` with
    ...
    async def download_media(self, *args, **kwargs):
        ...
        for `Degram.client.downloads.DownloadMethods.download_media`
    ...
    async def click(self, i=None, j=None,
        ...
        or `button.click <Degram.tl.custom.messagebutton.MessageButton.click>`
        ...
        Args:
            ...
            filter (`callable`):
                ...
                `MessageButton <Degram.tl.custom.messagebutton.MessageButton>`
                or `PollAnswer <Degram.tl._tl.PollAnswer>` argument.
    ...
    async def mark_read(self):
        ...
        `client.mark_read()
        <Degram.client.messages.MessageMethods.mark_read>`
        with both ``entity`` and ``message`` already set.
        """
    ...
    async def pin(self, *, notify=False, pm_oneside=False):
        ...
        `Degram.client.messages.MessageMethods.pin_message`
        with both ``entity`` and ``message`` already set.
        """
    ...
    async def unpin(self):
        ...
        `Degram.client.messages.MessageMethods.unpin_message`
        with both ``entity`` and ``message`` already set.
        """
    ...
    async def react(self, reaction=None):
        ...
        `Degram.client.messages.MessageMethods.send_reaction`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
