...
class Button:
    ...
    .. note::
        ...
        `Message.buttons <Degram.tl.custom.message.Message.buttons>`
    ...
    def inline(text, data=None):
        ...
        <Degram.events.callbackquery.CallbackQuery>` will trigger with the
        ...
        Args:
            bot (`hints.DialogLike`):
                ...
                .. note::
                    ...
                    <Degram.client.users.UserMethods.get_input_entity>`.
        ...
        Args:
            ...
            input_entity:
                ...
                .. note::
                    ...
                    `client.get_input_entity() <Degram.client.users.UserMethods.get_input_entity>`.
    ...
    def text(cls, text, *, resize=None, single_use=None, selective=None):
        ...
        <Degram.events.newmessage.NewMessage>`. You cannot distinguish
