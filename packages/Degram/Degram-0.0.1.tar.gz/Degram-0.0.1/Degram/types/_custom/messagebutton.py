...
class MessageButton:
    ...
    .. note::
        ...
        <Degram.tl.custom.button.Button>` instead.
    ...
    def client(self):
        """
        Returns the `Degram.client.telegramclient.TelegramClient`
    ...
    async def click(self, share_phone=None, share_geo=None, *, password=None):
        ...
        sent, and the sent `Message <Degram.tl.custom.message.Message>` returned.
