...
class InlineResult:
    ...
    async def click(self, entity=None, reply_to=None, comment_to=None,
        ...
        Args:
            ...
            reply_to (`int` | `Message <Degram.tl.custom.message.Message>`, optional):
                If present, the sent message will reply to this ID or message.

            comment_to (`int` | `Message <Degram.tl.custom.message.Message>`, optional):
    ...
    async def download_media(self, *args, **kwargs):
        ...
        <Degram.client.downloads.DownloadMethods.download_media>`.
        """
