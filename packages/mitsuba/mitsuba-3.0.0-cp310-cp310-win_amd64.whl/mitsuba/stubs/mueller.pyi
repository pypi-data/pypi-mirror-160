...
@overload
def rotate_mueller_basis(M: drjit::Matrix<mitsuba::Color<float,3>,4>, in_forward: mitsuba.Vector3f, in_basis_current: mitsuba.Vector3f, in_basis_target: mitsuba.Vector3f, out_forward: mitsuba.Vector3f, out_basis_current: mitsuba.Vector3f, out_basis_target: mitsuba.Vector3f):
    """
    Return the Mueller matrix for some new reference frames. This version
    rotates the input/output frames independently.
...
@overload
def rotate_mueller_basis_collinear(M: drjit::Matrix<mitsuba::Color<float,3>,4>, forward: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f):
    """
    Return the Mueller matrix for some new reference frames. This version
    applies the same rotation to the input/output frames.
