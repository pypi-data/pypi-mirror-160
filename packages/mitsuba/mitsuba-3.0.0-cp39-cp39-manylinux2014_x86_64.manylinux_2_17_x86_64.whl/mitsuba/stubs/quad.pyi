...
def chebyshev(n: int) -> drjit.scalar.ArrayXf:
    """
...
def composite_simpson(n: int) -> Tuple[drjit.scalar.ArrayXf, drjit.scalar.ArrayXf]:
    """
...
def composite_simpson_38(n: int) -> Tuple[drjit.scalar.ArrayXf, drjit.scalar.ArrayXf]:
    """
...
def gauss_legendre(n: int) -> Tuple[drjit.scalar.ArrayXf, drjit.scalar.ArrayXf]:
    """
...
def gauss_lobatto(n: int) -> Tuple[drjit.scalar.ArrayXf, drjit.scalar.ArrayXf]:
    """
