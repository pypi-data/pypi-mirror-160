...
@overload
def absorber(value: float) -> drjit.scalar.Matrix4f:
    """
...
@overload
def depolarizer(value: float = 1.0) -> drjit.scalar.Matrix4f:
    """
...
@overload
def diattenuator(x: float, y: float) -> drjit.scalar.Matrix4f:
    """
...
@overload
def linear_polarizer(value: float = 1.0) -> drjit.scalar.Matrix4f:
    """
...
@overload
def linear_retarder(phase: float) -> drjit.scalar.Matrix4f:
    """
...
@overload
def rotate_mueller_basis(M: drjit.scalar.Matrix4f, in_forward: mitsuba.Vector3f, in_basis_current: mitsuba.Vector3f, in_basis_target: mitsuba.Vector3f, out_forward: mitsuba.Vector3f, out_basis_current: mitsuba.Vector3f, out_basis_target: mitsuba.Vector3f) -> drjit.scalar.Matrix4f:
    """
...
@overload
def rotate_mueller_basis(M: drjit::Matrix<mitsuba::Color<float, 3ul>, 4ul>, in_forward: mitsuba.Vector3f, in_basis_current: mitsuba.Vector3f, in_basis_target: mitsuba.Vector3f, out_forward: mitsuba.Vector3f, out_basis_current: mitsuba.Vector3f, out_basis_target: mitsuba.Vector3f):
    """
    Return the Mueller matrix for some new reference frames. This version
    rotates the input/output frames independently.
...
@overload
def rotate_mueller_basis_collinear(M: drjit.scalar.Matrix4f, forward: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f) -> drjit.scalar.Matrix4f:
    """
    Return the Mueller matrix for some new reference frames. This version
...
@overload
def rotate_mueller_basis_collinear(M: drjit::Matrix<mitsuba::Color<float, 3ul>, 4ul>, forward: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f):
    """
    Return the Mueller matrix for some new reference frames. This version
    applies the same rotation to the input/output frames.
...
def rotate_stokes_basis(wi: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f) -> drjit.scalar.Matrix4f:
    """
...
@overload
def rotated_element(theta: float, M: drjit.scalar.Matrix4f) -> drjit.scalar.Matrix4f:
    """
...
@overload
def rotator(theta: float) -> drjit.scalar.Matrix4f:
    """
...
@overload
def specular_reflection(cos_theta_i: float, eta: drjit.scalar.Complex2f) -> drjit.scalar.Matrix4f:
    """
...
@overload
def specular_transmission(cos_theta_i: float, eta: float) -> drjit.scalar.Matrix4f:
    """
