...
ShadowEpsilon = ...
"Convert a string or number to a floating point number, if possible."
def chi2(arg0: drjit.scalar.ArrayXf64, arg1: drjit.scalar.ArrayXf64, arg2: float) -> Tuple[float, int, int, int]:
    """
...
def morton_decode2(m: int) -> drjit.scalar.Array2u: ...
def morton_decode3(m: int) -> drjit.scalar.Array3u: ...
def morton_encode2(v: drjit.scalar.Array2u) -> int: ...
def morton_encode3(v: drjit.scalar.Array3u) -> int: ...
def rlgamma(a, x):
    """
