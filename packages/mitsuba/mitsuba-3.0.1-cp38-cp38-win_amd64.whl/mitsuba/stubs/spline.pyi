...
@overload
def integrate_1d(min: float, max: float, values: numpy.ndarray[numpy.float32]) -> drjit.scalar.ArrayXf:
    """
...
@overload
def integrate_1d(nodes: numpy.ndarray[numpy.float32], values: numpy.ndarray[numpy.float32]) -> drjit.scalar.ArrayXf:
    """
