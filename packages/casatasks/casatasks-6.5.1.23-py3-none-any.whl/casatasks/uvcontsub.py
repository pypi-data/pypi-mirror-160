...
##################### 312dfbd81f1d0f9924a67349b54f1bc8 ##############################
...
class _uvcontsub:
    ...
    def __call__( self, vis='', field='', fitspw='', excludechans=False, combine='', solint='int', fitorder=int(0), spw='', want_cont=False ):
        ...
        task_result = None
        try:
            task_result = _uvcontsub_t( _pc.document['vis'], _pc.document['field'], _pc.document['fitspw'], _pc.document['excludechans'], _pc.document['combine'], _pc.document['solint'], _pc.document['fitorder'], _pc.document['spw'], _pc.document['want_cont'] )
        except Exception as exc:
            _except_log('uvcontsub', exc)
            raise
        finally:
