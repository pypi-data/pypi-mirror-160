...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/cecep/python_projects/archive-md-urls/.direnv/archive-md-urls-3.10'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/cecep/python_projects/archive-md-urls/.direnv/archive-md-urls-3.10/bin/deactivate.nu'
