...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/cecep/python_projects/archive-md-urls/.hatch/archive-md-urls-Gju-bf1v/tests.py311'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/cecep/python_projects/archive-md-urls/.hatch/archive-md-urls-Gju-bf1v/tests.py311/bin/deactivate.nu'
