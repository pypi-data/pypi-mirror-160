...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/cecep/python_projects/archive-md-urls/.hatch/archive-md-urls-Gju-bf1v/archive-md-urls'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/cecep/python_projects/archive-md-urls/.hatch/archive-md-urls-Gju-bf1v/archive-md-urls/bin/deactivate.nu'
