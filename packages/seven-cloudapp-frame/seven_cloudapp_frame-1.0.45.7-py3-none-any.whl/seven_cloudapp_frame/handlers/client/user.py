...
@LastEditTime: 2022-07-20 14:16:42
...
class LoginHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        invoke_result_data = user_base_model.save_user_by_openid(app_id, act_id, open_id, user_nick, avatar, union_id, self.get_remote_ip())
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
