...
class KoloMiddleware:
    ...
    def __call__(self, request: HttpRequest) -> HttpResponse:
        ...
        # This technically *isn't* threadsafe because saving a new config
        # here will overwrite it for other threads, but we don't actually
        # care. A different thread getting a newer config is acceptable.
