...
class objearth():
    ...
    def NDVI(self):
        ...
        red = xarray.where(self.DataArray.red==Nodata,numpy.nan,self.DataArray.red)
        nir = xarray.where(self.DataArray.nir==Nodata,numpy.nan,self.DataArray.nir)
        ...
        plt.clim(-1,1)
        plt.colorbar(orientation="vertical",fraction=fractionconstant*im_ratio)
        plt.show()
        return ndvi3
