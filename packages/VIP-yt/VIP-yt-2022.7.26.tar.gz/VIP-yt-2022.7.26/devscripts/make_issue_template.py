...
VERBOSE_TMPL = '''
  - type: checkboxes
    ...
    attributes:
      ...
      options:
        - label: Run **your** VIP-yt command with **-vU** flag added (`VIP-yt -vU <your command line>`)
          required: true
  ...
  - type: textarea
    ...
    attributes:
      ...
      placeholder: |
        ...
        [debug] Portable config "VIP-yt.conf": ['-i']
        [debug] Encodings: locale cp65001, fs utf-8, pref cp65001, out utf-8, error utf-8, screen utf-8
        [debug] VIP-yt version %(version)s [9d339c4] (win32_exe)
        ...
        [debug] Proxy map: {}
        [debug] Fetching release info: https://api.github.com/repos/VIP-yt/VIP-yt/releases/latest
        Latest version: %(version)s, Current version: %(version)s
        VIP-yt is up to date (%(version)s)
        <more lines>
      render: shell
    validations:
      required: true
...
def main():
    ...
    fields = {'version': read_version('VIP_yt/version.py')}
