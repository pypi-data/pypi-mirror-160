...
def main():
    ...
    args = parser.parse_args()[1] or ['VIP_yt/extractor/lazy_extractors.py']
    if len(args) != 1:
    ...
    from VIP_yt.extractor.common import InfoExtractor, SearchInfoExtractor
...
def get_all_ies():
    ...
    try:
        from VIP_yt.extractor.extractors import _ALL_CLASSES
    finally:
