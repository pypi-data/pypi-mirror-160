...
class FFmpegPostProcessor(PostProcessor):
    ...
    def stream_copy_opts(copy=True, *, ext=None):
        ...
        # See https://github.com/VIP-yt/VIP-yt/issues/2, #19042, #19024, https://trac.ffmpeg.org/ticket/6016
...
class FFmpegEmbedSubtitlePP(FFmpegPostProcessor):
    ...
    def run(self, info):
        ...
        # See: https://github.com/VIP-yt/VIP-yt/issues/1870, https://github.com/VIP-yt/VIP-yt/issues/1385
        '''
    ...
    def can_merge(self):
        ...
        if is_outdated_version(
            ...
            warning = ('Your copy of %s is outdated and unable to properly mux separate video and audio files, '
                       'VIP-yt will download single file media. '
