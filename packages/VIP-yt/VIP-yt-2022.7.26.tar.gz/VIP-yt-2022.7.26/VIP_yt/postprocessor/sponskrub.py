    ...
    def __init__(self, downloader, path='', args=None, ignoreerror=False, cut=False, force=False, _from_cli=False):
        ...
        if not _from_cli:
            self.deprecation_warning(
                'VIP_yt.postprocessor.SponSkrubPP support is deprecated and may be removed in a future version. '
                'Use VIP_yt.postprocessor.SponsorBlock and VIP_yt.postprocessor.ModifyChaptersPP instead')
