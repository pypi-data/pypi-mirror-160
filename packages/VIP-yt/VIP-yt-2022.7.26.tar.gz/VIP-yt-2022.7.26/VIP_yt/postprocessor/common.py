...
class PostProcessor(metaclass=PostProcessorMetaClass):
    ...
    def report_error(self, text, *args, **kwargs):
        self.deprecation_warning('"VIP_yt.postprocessor.PostProcessor.report_error" is deprecated. '
                                 'raise "VIP_yt.utils.PostProcessingError" instead')
        if self._downloader:
    ...
    def report_progress(self, s):
        ...
        self._downloader.to_console_title(self._downloader.evaluate_outtmpl(
            progress_template.get('postprocess-title') or 'VIP-yt %(progress._default_template)s',
            progress_dict))
