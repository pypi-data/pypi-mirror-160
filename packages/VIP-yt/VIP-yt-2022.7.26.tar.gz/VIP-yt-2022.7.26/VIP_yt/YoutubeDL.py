...
class YoutubeDL:
    ...
    postprocessors:    A list of dictionaries, each with an entry
                       * key:  The name of the postprocessor. See
                               VIP_yt/postprocessor/__init__.py for a list.
    ...
    the downloader (see VIP_yt/downloader/common.py):
    ...
    def __init__(self, params=None, auto_init=True):
        ...
        if current_version < MIN_RECOMMENDED:
            msg = ('Support for Python version %d.%d has been deprecated. '
                   'See  https://github.com/VIP-yt/VIP-yt/issues/3764  for more details.'
    ...
    def _format_text(self, handle, allow_colors, text, f, fallback=None, *, test_encoding=False):
        ...
        if test_encoding:
            original_text = text
            # handle.encoding can be None. See https://github.com/VIP-yt/VIP-yt/issues/2711
    ...
    def process_video_result(self, info_dict, download=True):
        ...
        for format_id, ambiguous_formats in formats_dict.items():
            ...
            for i, format in enumerate(ambiguous_formats):
                ...
                # See https://github.com/VIP-yt/VIP-yt/issues/1282
    ...
    def process_subtitles(self, video_id, normal_subtitles, automatic_captions):
        ...
        if self.params.get('allsubtitles', False):
            ...
            # given in subtitleslangs. See https://github.com/VIP-yt/VIP-yt/issues/1041
            requested_langs = []
    ...
    def _setup_opener(self):
        ...
        def file_open(*args, **kwargs):
            raise urllib.error.URLError('file:// scheme is explicitly disabled in VIP-yt for security reasons')
