...
class AbemaTVIE(AbemaTVBaseIE):
    ...
    _TESTS = [{
        ...
        'skip': 'Not supported until VIP-yt implements native live downloader OR AbemaTV can start a local HTTP server',
    }]
    _TIMETABLE = None
    ...
    def _real_extract(self, url):
        ...
        if is_live:
            self.report_warning("This is a livestream; VIP-yt doesn't support downloading natively, but FFmpeg cannot handle m3u8 manifests from AbemaTV")
