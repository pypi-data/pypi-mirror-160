...
An attribute "_VIP_yt__identifier" may be inserted into the module if it uses an ambiguous namespace"""
...
try:
    ...
    try:
        ...
        try:
            ...
            Cryptodome_AES._VIP_yt__identifier = 'pycrypto'
...
try:
    ...
    # sqlite support. See: https://github.com/VIP-yt/VIP-yt/issues/544
    sqlite3 = None
...
try:
    ...
    # See https://github.com/VIP-yt/VIP-yt/issues/2633
    websockets = None
...
try:
    ...
    if hasattr(xattr, 'set'):  # pyxattr
        xattr._VIP_yt__identifier = 'pyxattr'
