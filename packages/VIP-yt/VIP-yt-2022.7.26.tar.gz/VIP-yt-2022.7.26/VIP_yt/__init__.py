f'You are using an unsupported version of Python. Only Python versions 3.7 and above are supported by VIP-yt'  # noqa: F541
...
def validate_options(opts):
    ...
    if opts.format == 'best':
        warnings.append('.\n         '.join((
            ...
            'To let VIP-yt download and merge the best available formats, simply do not pass any format selection',
...
def get_postprocessors(opts):
    ...
    # See https://github.com/VIP-yt/VIP-yt/issues/204 , https://github.com/faissaloo/SponSkrub/issues/29
...
def _real_main(argv=None):
    ...
    with YoutubeDL(ydl_opts) as ydl:
        ...
        if opts.update_self and updater.update() and actual_use:
            ...
            ydl.report_warning('Restart VIP-yt to use the updated version')
        ...
        if not actual_use:
            ...
            parser.error(
                ...
                'Type VIP-yt --help to see a list of all options.')
