...
def parseOpts(overrideArguments=None, ignore_config_files='if_override'):
    ...
    def add_config(label, path, user=False):
        ...
        # Eg: ('VIP-yt', 'youtube-dlc', 'youtube-dl') will look for
        # the configuration file of any of these three packages
        for package in ('VIP-yt',):
            if user:
...
class _YoutubeDLOptionParser(optparse.OptionParser):
    ...
    def __init__(self):
        super().__init__(
            prog='VIP-yt' if detect_variant() == 'source' else None,
            version=__version__,
            usage='%prog [OPTIONS] URL [URL...]',
            epilog='See full documentation at  https://github.com/VIP-yt/VIP-yt#readme',
...
def create_parser():
    ...
    general.add_option(
        ...
        help=(
            ...
            'Use the value "auto" to let VIP-yt guess ("auto_warning" to emit a warning when guessing). '
    ...
    general.add_option(
        ...
        callback_kwargs={
            ...
            'configurations by reverting some of the changes made in VIP-yt. '
    ...
    authentication.add_option(
        ...
        help='Account password. If this option is left out, VIP-yt will ask interactively')
    authentication.add_option(
        '-2', '--twofactor',
    ...
    authentication.add_option(
        ...
        help='Multiple-system operator account password. If this option is left out, VIP-yt will ask interactively')
    authentication.add_option(
        '--ap-list-mso',
    ...
    authentication.add_option(
        ...
        help='Password for client certificate private key, if encrypted. '
             'If not provided, and the key is encrypted, VIP-yt will ask interactively')
    ...
    verbosity.add_option(
        ...
        # help='Contact the VIP-yt server for debugging')
        help=optparse.SUPPRESS_HELP)
    verbosity.add_option(
        '--no-call-home',
        dest='call_home', action='store_false',
        # help='Do not contact the VIP-yt server for debugging (default)')
        help=optparse.SUPPRESS_HELP)
    ...
    filesystem.add_option(
        ...
        help='Location in the filesystem where youtube-dl can store some downloaded information (such as client ids and signatures) permanently. By default $XDG_CACHE_HOME/VIP-yt or ~/.cache/VIP-yt')
    filesystem.add_option(
...
def _hide_login_info(opts):
    write_string(
        'DeprecationWarning: "VIP_yt.options._hide_login_info" is deprecated and may be removed in a future version. '
        'Use "VIP_yt.utils.Config.hide_login_info" instead\n')
