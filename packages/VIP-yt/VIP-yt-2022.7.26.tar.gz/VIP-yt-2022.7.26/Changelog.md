...
* Dispatch the workflow https://github.com/VIP-yt/VIP-yt/actions/workflows/build.yml on master
-->
...
* [build] Add homebrew taps `VIP-yt/taps/VIP-yt` by [nao20010128nao](https://github.com/nao20010128nao)
* [build] Fix bug in making `VIP-yt.tar.gz`
...
* Add `--extractor-args` to pass some extractor-specific arguments. See [readme](https://github.com/VIP-yt/VIP-yt#extractor-arguments)
...
* Field `additional_urls` to download additional videos from metadata using [`--parse-metadata`](https://github.com/VIP-yt/VIP-yt#modifying-metadata)
...
* **Subtitle extraction from manifests** by [fstirlitz](https://github.com/fstirlitz). See [be6202f](https://github.com/VIP-yt/VIP-yt/commit/be6202f12b97858b9d716e608394b51065d0419f) for details
...
* Fix `playlist_index` and add `playlist_autonumber`. See [#302](https://github.com/VIP-yt/VIP-yt/issues/302) for details
* Add experimental option `--check-formats` to test the URLs before format selection
* Option `--compat-options` to revert [some of VIP-yt's changes](https://github.com/VIP-yt/VIP-yt#differences-in-default-behavior)
...
* Improve the VIP-yt.sh script by [fstirlitz](https://github.com/fstirlitz)
...
### 2021.02.24
* Moved project to an organization [VIP-yt](https://github.com/VIP-yt)
* **Completely changed project name to VIP-yt** by [Pccode66](https://github.com/Pccode66) and [pukkandan](https://github.com/pukkandan)
...
* [Readthedocs](https://VIP-yt.readthedocs.io) support by [shirt](https://github.com/shirt-dev)
...
* Improve build/updater: by [pukkandan](https://github.com/pukkandan) and [shirt](https://github.com/shirt-dev)
    ...
    * Updater looks for both `VIP-yt` and `youtube-dlc` in releases for future-proofing
...
* Plugin support ([documentation](https://github.com/VIP-yt/VIP-yt#plugins))
...
* **Configuration files:**
    * Portable configuration file: `./VIP-yt.conf`
    * Allow the configuration files to be named `VIP-yt` instead of `youtube-dlc`. See [this](https://github.com/VIP-yt/VIP-yt#configuration) for details
* Add PyPI release
...
* [docs] Changed sponskrub links to point to [VIP-yt/SponSkrub](https://github.com/VIP-yt/SponSkrub) since I am now providing both linux and windows releases
