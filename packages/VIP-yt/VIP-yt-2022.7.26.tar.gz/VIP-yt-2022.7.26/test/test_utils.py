...
class TestUtil(unittest.TestCase):
    ...
    def test_expand_path(self):
        ...
        os.environ['VIP_yt_EXPATH_PATH'] = 'expanded'
        self.assertEqual(expand_path(env('VIP_yt_EXPATH_PATH')), 'expanded')
        ...
        try:
            ...
            self.assertEqual(
                expand_path('~/%s' % env('VIP_yt_EXPATH_PATH')),
...
'''
    ...
    def test_rot47(self):
        self.assertEqual(rot47('VIP-yt'), r'JE\5=A')
        self.assertEqual(rot47('VIP-yt'), r'*%\s{!')
