...
from VIP_yt.compat import compat_os_name
from VIP_yt.extractor import YoutubeIE
from VIP_yt.extractor.common import InfoExtractor
from VIP_yt.postprocessor.common import PostProcessor
from VIP_yt.utils import (
    ExtractorError,
    LazyList,
    OnDemandPagedList,
    int_or_none,
...
class TestYoutubeDL(unittest.TestCase):
    ...
    def test_prepare_outtmpl_and_filename(self):
        ...
        os.environ['__VIP_yt_var'] = 'expanded'
        envvar = '%__VIP_yt_var%' if compat_os_name == 'nt' else '$__VIP_yt_var'
    ...
    def test_playlist_items_selection(self):
        ...
        # Tests for https://github.com/VIP-yt/VIP-yt/issues/720
        # https://github.com/VIP-yt/VIP-yt/issues/302
