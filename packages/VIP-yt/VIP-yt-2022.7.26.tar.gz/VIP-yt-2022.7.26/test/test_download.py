...
import VIP_yt.YoutubeDL  # isort: split
from VIP_yt.extractor import get_info_extractor
...
class YoutubeDL(VIP_yt.YoutubeDL):
...
def generator(test_case, tname):
    ...
    def test_template(self):
        ...
        ie = VIP_yt.extractor.get_info_extractor(test_case['name'])()
