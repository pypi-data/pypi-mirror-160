...
def get_cnn_transformer_decipher_model(ciphers_n=100, seq_len=48, seq_depth=20, kernel_count=128, emb_size=256,
                                       n_layers=4, n_heads=8, ff_dim=1024, activation='relu', dropout=0.1,
                                       kernel_size=5, n_strides=3):
    input_layer = Input(shape=(seq_len, seq_depth), name='input_layer')
    x = input_layer
