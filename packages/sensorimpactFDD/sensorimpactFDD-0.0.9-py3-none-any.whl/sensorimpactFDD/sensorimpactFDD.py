...
class SensorImpactFDD:
    def __init__(self, technical_route='general_guidance', building_type_or_name='small_commercial_building',
        ...
        """
        self.config = {
          "simulation_metadata_name": "summary_results_algorithm_Knoxville_TN_AMY_brief_2.csv",
          ...
          "considered_sensors_in_sensor_inaccuracy_analysis": ["cooling_electricity [W]",
            ...
            "environment_site_diffuse_solar_radiation_rate_per_area [W/m2]",
            "environment_site_direct_solar_radiation_rate_per_area [W/m2]",
            "environment_site_outdoor_air_barometric_pressure [Pa]",
            "environment_site_outdoor_air_drybulb_temperature [C]",
            "environment_site_outdoor_air_relative_humidity [%]",
            "environment_site_outdoor_air_wetbulb_temperature [C]",
            "environment_site_rain_status []",
            "rooftop_cooling_coil_outlet_system_node_temperature [C]",
            "rooftop_heating_coil_outlet_system_node_temperature [C]",
            "rooftop_mixed_air_outlet_system_node_temperature [C]",
            "rooftop_supply_fan_outlet_system_node_temperature [C]",
            "room_102_supply_inlet_system_node_temperature [C]",
            "room_102_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_103_supply_inlet_system_node_temperature [C]",
            "room_103_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_104_supply_inlet_system_node_temperature [C]",
            "room_104_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_105_supply_inlet_system_node_temperature [C]",
            "room_105_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_106_supply_inlet_system_node_temperature [C]",
            "room_106_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_202_supply_inlet_system_node_temperature [C]",
            "room_202_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_203_supply_inlet_system_node_temperature [C]",
            "room_203_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_204_supply_inlet_system_node_temperature [C]",
            "room_204_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_205_supply_inlet_system_node_temperature [C]",
            "room_205_vav_reheat_damper_outlet_system_node_temperature [C]",
            "room_206_supply_inlet_system_node_temperature [C]",
            "room_206_vav_reheat_damper_outlet_system_node_temperature [C]",
            "1f_plenum_zone_air_relative_humidity [%]",
            "2f_plenum_zone_air_relative_humidity [%]",
            "room_101_zone_air_relative_humidity [%]",
            "room_102_zone_air_relative_humidity [%]",
            "room_103_zone_air_relative_humidity [%]",
            "room_104_zone_air_relative_humidity [%]",
            "room_105_zone_air_relative_humidity [%]",
            "room_106_zone_air_relative_humidity [%]",
            "room_201_zone_air_relative_humidity [%]",
            "room_202_zone_air_relative_humidity [%]",
            "room_203_zone_air_relative_humidity [%]",
            "room_204_zone_air_relative_humidity [%]",
            "room_205_zone_air_relative_humidity [%]",
            "room_206_zone_air_relative_humidity [%]",
            "1f_plenum_zone_mean_air_temperature [C]",
            "2f_plenum_zone_mean_air_temperature [C]",
            "room_101_zone_mean_air_temperature [C]",
          ...
          "sensor_category_dict": {"cooling_electricity [W]": "electiricty_meter",
          ...
          "sensor_fault_probability_table_dir": "sensor_fault_probability_table.csv",

          "selected_fault_types_for_sensor_inaccuracy_analysis": ["air_handling_unit_fan_motor_degradation",
          ...
          "sensor_group_info_dir": "Suggested Sensor Sets.csv",

          "fault_type_list_sensor_cost_analysis": ["thermostat_bias", "economizer_opening_stuck"],

          "baseline_sensor_set_sensor_cost_analysis": [],

          "candidate_sensor_set_sensor_cost_analysis": [],

          "fault_prevalence_dict": {
                "air_handling_unit_fan_motor_degradation": 0.255,
                "baseline": 0.05,
                "biased_economizer_sensor_mixed_t": 0.19,
                "biased_economizer_sensor_oat": 0.19,
                "biased_economizer_sensor_outdoor_rh": 0.19,
                "biased_economizer_sensor_return_rh": 0.19,
                "biased_economizer_sensor_return_t": 0.19,
                "condenser_fan_degradation": 0.255,
                "condenser_fouling": 0,
                "duct_fouling": 0.05,
                "economizer_opening_stuck": 0.16,
                "excessive_infiltration": 0.15,
                "hvac_setback_error_delayed_onset": 0.05,
                "hvac_setback_error_early_termination": 0.05,
                "hvac_setback_error_no_overnight_setback": 0.05,
                "improper_time_delay_setting_in_occupancy_sensors": 0.19,
                "lighting_setback_error_delayed_onset": 0.05,
                "lighting_setback_error_early_termination": 0.05,
                "lighting_setback_error_no_overnight_setback": 0.05,
                "liquid_line_restriction": 0.03,
                "non_standard_charging_2": 0.516,
                "oversized_equipment_at_design": 0.4,
                "presence_of_non_condensable": 0,
                "return_air_duct_leakages": 0.456,
                "supply_air_duct_leakages": 0.456,
                "thermostat_bias": 0.19},

          "guidance_bldg_dict": {"small_commercial_building": "None"},

          "algorithm_dict": {"random_forest": "None", "gradient_boosting": "None"}}
