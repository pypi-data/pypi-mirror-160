...
class RhinoView extends base_1.DOMWidgetView {
    ...
    render() {
        ...
        load3dmModel(scene, '/tree/' + this.path, {
            ...
            error.textContent = '3dm File ' + this.model.get('value') + ' was not found';
