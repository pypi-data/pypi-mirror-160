...
class hmath_setting:
    class memo:
        ...
        def HDD_save_reset():
            ...
            memo_plk.write(str(dumps({"B":{},"ln":{},"rad":{},"exp":{},"sin":{},"cos":{},"tan":{},"csc":{},"sec":{},"cot":{},"log":{},"log2":{},"zeta":{},"asin":{},"acos":{},"atan":{},"acsc":{},"asec":{},"acot":{},"sinh":{},"cosh":{},"tanh":{},"csch":{},"sech":{},"coth":{},"cube":{},"sqrt":{},"log10":{},"asinh":{},"acosh":{},"atanh":{},"acsch":{},"asech":{},"acoth":{},"Gamma":{},"diganma":{},"radical":{},"factorial":{},"reduct_fract":{},"prime_test":{},"prime_factorization":{}})))
            memo_plk.close()
    class fract:
    ...
    def memo(*args) -> object:
        ...
        if memo == 0:
            ...
            if args_ in __corresponding_dictionary[func.__name__]:
                ...
                if len(args) == 3:
                    ans = new_func(args[0], args[1], args[2])
                __corresponding_dictionary[func.__name__][str(args)] = ans
...
class fract:
    ...
    ((3+5j) / 3)
    """
    def __init__(self, mole, deno, __reduct_fract_count = 1):
        self.mole = mole
        self.deno = deno
        if hmath_setting.fract.max_about_minute_limit < __reduct_fract_count:
            self = reduct_fract(self)
            self.__reduct_fract_count = 0
        else:
            self.__reduct_fract_count = __reduct_fract_count
    ...
    def __add__(self, other):
        if not type(other) == fract:
            return fract(self.mole + other * self.deno, self.deno)
        return fract(self.mole * other.deno + other.mole * self.deno, self.deno * other.deno, max(self.__reduct_fract_count, other.__reduct_fract_count) + 2)
    ...
    def __mul__(self, other):
        if not type(other) == fract:
            return fract(self.mole * other, self.deno)
        return fract(self.mole * other.mole, self.deno * other.deno, max(self.__reduct_fract_count, other.__reduct_fract_count) + 1)
    def __rmul__(self, other):
        return fract(self.mole * other, self.deno)
    #/
    def __truediv__ (self, other):
        if not type(other) == fract:
            return fract(self.mole, self.deno * other)
        return fract(self.mole * other.deno, self.deno * other.mole, max(self.__reduct_fract_count, other.__reduct_fract_count) + 1)
    def __rtruediv__(self, other):
        return fract(self.deno * other, self.mole)
    ...
    def __pow__ (self, other):
        if not type(other) == fract:
            return fract(self.mole ** other, self.deno ** other)
        return fract(self.mole ** (other.mole / other.deno), self.deno ** (other.mole / other.deno), self.__reduct_fract_count)
...
def reduct_fract(_fr) -> fract:
    ...
    if type(_fr.mole) != complex and type(_fr.deno) != complex and _fr.__reduct_fract_count != 0:
...
@__list
@__memo
def prime_factorization(_n : int) -> array | list:
    """
...
try:
    ...
    __corresponding_dictionary = {"B":{},"ln":{},"rad":{},"exp":{},"sin":{},"cos":{},"tan":{},"csc":{},"sec":{},"cot":{},"log":{},"log2":{},"zeta":{},"asin":{},"acos":{},"atan":{},"acsc":{},"asec":{},"acot":{},"sinh":{},"cosh":{},"tanh":{},"csch":{},"sech":{},"coth":{},"cube":{},"sqrt":{},"log10":{},"asinh":{},"acosh":{},"atanh":{},"acsch":{},"asech":{},"acoth":{},"Gamma":{},"diganma":{},"radical":{},"factorial":{},"reduct_fract":{},"prime_test":{},"prime_factorization":{}}