...
class Mixture:
    ...
    def mix_mu(self, energy, thickness_cm=0.01, components=0):
        ...
        logger.info("""%-7s %-7s %-7s %-7s %-8s %-8s %-8s %-15s""" %('atom', 'wt frac', "f'", "f''", 'total xs', 'rayleigh', 'compton', 'phot+compton'))
        for w in self.stoi.keys():
            ...
            logger.info('%-7s %-7.3f %-7.3f %-7.3f %-8.3f %-8.3f %-8.3f %-8.3f' \
