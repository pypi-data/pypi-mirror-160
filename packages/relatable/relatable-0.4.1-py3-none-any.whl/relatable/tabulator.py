...
class Tabulator:
    ...
    def tabulate(self):
        if self._check_no_objects():
            more_docs = [(k, self._extract_array_field(k), self.all_keys) for k in self._get_array_fields()]
