switch (width) {
    ...
    switch (depth) {
        ...
        case 17 :
        return TemplatedFn(2, 17);
        break;

        case 18 :
        return TemplatedFn(2, 18);
        break;

        case 19 :
        return TemplatedFn(2, 19);
        break;

        case 20 :
        return TemplatedFn(2, 20);
        break;

        default :
        throw std::runtime_error ( "Legitimate depth of 2<->20 for records with width 2 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->6 for records with width 4 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 17 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 18 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 19 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 20 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 21 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 22 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 23 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 24 exceeds limit" );
    }
    break;
    ...
    switch (depth) {
        ...
        default :
        throw std::runtime_error ( "Legitimate depth of 2<->2 for records with width 25 exceeds limit" );
    }
    break;
