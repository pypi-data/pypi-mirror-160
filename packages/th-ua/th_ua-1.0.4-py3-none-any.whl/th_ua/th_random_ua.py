...
#
import os
# filepath = os.path.join(os.path.dirname(os.path.realpath(__file__)), "random_ua.json")
# print(filepath)
THIS_DIR = os.path.dirname(os.path.realpath(__file__))
SPINNERS_PATH = os.path.join(THIS_DIR, "random_ua.json")
# print(SPINNERS_PATH)
with open(SPINNERS_PATH, 'r', encoding='utf-8') as p:
