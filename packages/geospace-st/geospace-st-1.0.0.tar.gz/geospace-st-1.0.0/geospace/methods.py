...
class CellChat:
    ...
    def run(self, adata, pos=None, group_by="class"):
        ...
        self.robjects.r('''
                    f <- function(s, pos=NULL) {
                        ...
                        library(Matrix)
                        cellchat <- computeCommunProb(cellchat, pos=pos, prior.thresholds=prior.thresholds,
        ...
        out = self.robjects.r['f'](adata, pos)
...
class BayesSpace:
    """
    Bayesspace method from *citation*
    """
