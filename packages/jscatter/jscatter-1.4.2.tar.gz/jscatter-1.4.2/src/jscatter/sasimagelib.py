...
class sasImage(SubArray, np.ma.MaskedArray):
    ...
    def __new__(cls, file, detector_distance=None, center=None,
        ...
        flip : int, default None
            ...
            Other data are not modified, only pixel data are fliped.
    ...
    def lineFindCenter(self, minmax=[2, 80], use='COM', show=False, darkline=None):
        ...
        darkline : dataArray
            ...
            This is subtracted before any processing and should have same countingtime as sasImage.
    ...
    def lineAverage(self, sigma=3, darkline=None, whiteline=None):
        ...
        Notes
        -----
        - detector_distance in attributes is used for scattering vector alculation.
        ...
        if sigma > 0:
            ...
            peaks = np.abs(image - image.mean(axis=0)) > (sigma * image.std(axis=0))
            try:
                # in newer numpy versions with 'where' the later simplifies to this
