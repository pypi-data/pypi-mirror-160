...
set_target_properties(mindquantum::C_mindquantum PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<\$<COMPILE_LANGUAGE:C>:\$<\$<BOOL:ON>:USE_OPENMP>;\$<\$<BOOL:OFF>:USE_PARALLEL_STL>;\$<\$<AND:\$<CONFIG:RELEASE>,\$<COMPILE_LANGUAGE:CXX>>:_FORTIFY_SOURCE=2>>;\$<\$<COMPILE_LANGUAGE:C>:_USE_MATH_DEFINES>"
  INTERFACE_COMPILE_OPTIONS "\$<\$<AND:\$<COMPILE_LANGUAGE:C>,\$<OR:\$<CONFIG:RELEASE>,\$<CONFIG:RELWITHDEBINFO>>>:-ffast-math;-O3>;\$<\$<COMPILE_LANGUAGE:C>:-Wa,-mbig-obj>"
  INTERFACE_LINK_OPTIONS "\$<\$<AND:\$<BOOL:LINKER_STRIP_ALL>,\$<AND:\$<LINK_LANGUAGE:C>,\$<OR:\$<CONFIG:RELEASE>,\$<CONFIG:RELWITHDEBINFO>>>>:LINKER:--strip-all>;\$<\$<AND:\$<BOOL:ENABLE_STACK_PROTECTION>,\$<LINK_LANGUAGE:C>>:-fstack-protector-all>"
)
...
set_target_properties(mindquantum::CXX_mindquantum PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<\$<COMPILE_LANGUAGE:CXX>:\$<\$<BOOL:ON>:USE_OPENMP>;\$<\$<BOOL:OFF>:USE_PARALLEL_STL>;\$<\$<AND:\$<CONFIG:RELEASE>,\$<COMPILE_LANGUAGE:CXX>>:_FORTIFY_SOURCE=2>>;\$<\$<COMPILE_LANGUAGE:CXX>:_USE_MATH_DEFINES>"
  INTERFACE_COMPILE_OPTIONS "\$<\$<AND:\$<COMPILE_LANGUAGE:CXX>,\$<OR:\$<CONFIG:RELEASE>,\$<CONFIG:RELWITHDEBINFO>>>:-ffast-math;-O3>;\$<\$<COMPILE_LANGUAGE:CXX>:-Wa,-mbig-obj>"
  INTERFACE_LINK_OPTIONS "\$<\$<AND:\$<BOOL:LINKER_STRIP_ALL>,\$<AND:\$<LINK_LANGUAGE:CXX>,\$<OR:\$<CONFIG:RELEASE>,\$<CONFIG:RELWITHDEBINFO>>>>:LINKER:--strip-all>;\$<\$<AND:\$<BOOL:ENABLE_STACK_PROTECTION>,\$<LINK_LANGUAGE:CXX>>:-fstack-protector-all>"
)
