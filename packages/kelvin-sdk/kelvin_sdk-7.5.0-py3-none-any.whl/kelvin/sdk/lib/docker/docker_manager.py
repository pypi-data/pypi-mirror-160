...
class DockerManager:
    ...
    def run_app_docker_image(self, project_emulation_object: ProjectEmulationObject) -> bool:
        ...
        # 4.1.2 - add credential environment vars for client access during emulation
        ...
        # 9 - If there is a specific app configuration file, insert it into the container and override
        if container_result:
        ...
        # 10 - Variables for logging purposes
