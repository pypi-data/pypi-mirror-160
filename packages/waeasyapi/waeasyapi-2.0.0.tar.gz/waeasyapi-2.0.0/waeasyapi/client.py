...
class Client:
    ...
    def __init__(self, session=None, auth=None, **options):
        ...
        self.cert_path = file_dir + '/cacert.pem'
    ...
    def _update_user_agent_header(self, options):
        user_agent = "{}{} {}".format('WAEasyAPI-Python/', self._get_version(),
    ...
    def _get_version(self):
        ...
        try: # nosemgrep : gitlab.bandit.B110
            version = pkg_resources.require("waeasyapi")[0].version
    ...
    def request(self, method, path, **options):
        """
        Dispatches a request to the WAEasyAPI HTTP API
        """
