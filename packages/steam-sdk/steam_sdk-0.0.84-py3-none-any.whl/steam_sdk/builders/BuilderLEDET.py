...
class BuilderLEDET:
    ...
    def calcElectricalOrder(self, flag_plot: bool = False):
        ...
        if self.model_data and len(self.model_data.CoilWindings.electrical_pairs.overwrite_electrical_order) > 0:
            ...
            return np.array(self.model_data.CoilWindings.electrical_pairs.overwrite_electrical_order)  # stop here the function without calculating the electrical order
