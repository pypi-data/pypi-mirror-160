...
class ParserDAKOTA:
    ...
    def __init__(self, builder_DAKOTA: BuilderDAKOTA = BuilderDAKOTA()):
        """
            Initialization using a BuilderDAKOTA object containing DAKOTA parameter structure
        """

        self.builder_DAKOTA: BuilderDAKOTA = builder_DAKOTA
    ...
    def readFromYaml(self, file_name: str, verbose: bool = True):
        ...
        with open(file_name + '.yaml', "r") as stream:
            ...
            self.builder_DAKOTA.data_DAKOTA = dDAKOTA.DAKOTA_analysis(**dictionary_yaml)
    ...
    def writeDAKOTA2in(self, full_path_file_name: str, verbose: bool = False):
        ...
        dict_to_in(self.builder_DAKOTA.data_DAKOTA.dict(), full_path_file_name + '.in')
