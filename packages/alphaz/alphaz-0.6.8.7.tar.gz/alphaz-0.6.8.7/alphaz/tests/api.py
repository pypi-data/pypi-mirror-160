...
class API(AlphaTest):
    ...
    def get_api_answer(
        ...
        return api_lib.get_api_answer(
            api.get_url(local=True) + route, params=params, method=method
        )
    ...
    def test_status_none_description(self):
        params = {"status": None, "description": "test"}
        answer = self.get_api_answer(route="/test/status", method="GET", params=params)
    ...
    def test_status_description(self):
        params = {"status": "test", "description": "test"}
        answer = self.get_api_answer(route="/test/status", method="GET", params=params)
        self.assert_equal(answer.status_description, params["description"])
    ...
    def test_status_description_none(self):
        params = {"status": "test", "description": None}
        answer = self.get_api_answer(route="/test/status", method="GET", params=params)
        self.assert_equal(answer.status_description, params["status"])
        self.assert_equal(answer.status, params["status"])
