...
class DtSpanProcessor(SpanProcessor):
    ...
    def __init__(self, **kwargs):
        ...
        self._fresh_spans = []  # type: List[WatchedSpan]
        # The active spans which this span processor is keeping track of.
        self._span_watchlist = []  # type: List[WatchedSpan]
        self._span_watchlist_size = 0
        # A weak ref mapping of sdk spans to watched spans. on_end the watched
        # span will keep a strong ref to ensure the sdk span is still available
        # until the next export run.
