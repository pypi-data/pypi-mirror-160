...
class SimplifiedTetrisAVELAEnv(_PotentialBasedShapingReward, SimplifiedTetrisBinaryEnv):
...
register_env(
    incomplete_id=f"simplifiedtetris-AVELA", 
    entry_point=f"gym_simplifiedtetris_AVELA.envs:SimplifiedTetrisAVELAEnv",
)