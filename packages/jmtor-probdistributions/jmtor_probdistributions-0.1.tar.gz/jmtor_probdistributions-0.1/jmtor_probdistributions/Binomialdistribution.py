...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        #           defined previously.
        sum_pos_out = sum(self.data)
        self.p = sum_pos_out / len(self.data)
    ...
    def plot_bar(self):
        ...
        plt.hist(self.data)
        plt.title('Histogram of Binomial Distribution from Data')
        plt.xlabel('data')
        plt.ylabel('count')       
    ...
    def pdf(self, k):
        ...
        factorial_pdf = math.factorial(self.n) / (math.factorial(k) * math.factorial(self.n-k))
        return factorial_pdf * math.pow(self.p,k) * math.pow(1-self.p,self.n-k)        
    ...
    def __add__(self, other):
        ...
        result.mu = self.calculate_mean()
        result.sigma = self.calculate_stdev()
        return result
