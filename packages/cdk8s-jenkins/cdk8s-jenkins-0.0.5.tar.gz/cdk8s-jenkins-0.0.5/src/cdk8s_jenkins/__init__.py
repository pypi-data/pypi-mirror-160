...
class Jenkins(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        base_plugins: typing.Optional[typing.Sequence["Plugin"]] = None,
        disable_csrf_protection: typing.Optional[builtins.bool] = None,
        metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None,
        plugins: typing.Optional[typing.Sequence["Plugin"]] = None,
        seed_jobs: typing.Optional[typing.Sequence["SeedJob"]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
