...
_DIFFTESTARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='unannotated_needing_recreate', full_name='tecton_proto.args.DiffTestArgs.unannotated_needing_recreate', index=6,
