...
class FilteredSource:
    ...
    :param start_time_offset: (Optional) FilteredSource will pre-filter the data source to the time range ``[start_time + start_time_offset, end_time)``. Must be zero or negative. Defaults to zero.
