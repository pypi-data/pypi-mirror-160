...
setup(
    ...
    packages=["ecom_utils", "ecom_utils.tgd", "ecom_utils.pon", "ecom_utils.scient", "ecom_utils.scient.airflow", "ecom_utils.scient.airflow.core", "ecom_utils.scient.airflow.sql", "ecom_utils.scient.airflow.sql.mssql", "ecom_utils.scient.airflow.sql.postgres"],
    package_data={
        # 'starwars_ipsum': ['*.txt']
    },
