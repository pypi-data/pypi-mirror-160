...
class VtkVisualize(VtkVisualizeBase):
    ...
    def load_uGrid_file(self, filename):
        # Make unstructured grid.
        self._uGrid = vtk.vtkUnstructuredGridReader()
        self._uGrid.SetFileName(filename)
        self._uGrid.Update()
    ...
    def show_contour(self):
        ...
        scalarBarActor.GetLabelTextProperty().SetColor(124/255, 124/255, 124/255)
        scalarBarActor.GetLabelTextProperty().SetFontSize(13)
        scalarBarActor.GetLabelTextProperty().SetBold(False)
        ...
        scalarBarActor.SetWidth(0.05)
        scalarBarActor.SetHeight(0.6)
        scalarBarActor.SetNumberOfLabels(8)
        scalarBarActor.SetOrientationToVertical()
        scalarBarActor.GetPositionCoordinate().SetValue(0.9, 0.2)
        self._renderer.AddActor(scalarBarActor)
        # Show render window and start interact.
        self._interactor.Start()
