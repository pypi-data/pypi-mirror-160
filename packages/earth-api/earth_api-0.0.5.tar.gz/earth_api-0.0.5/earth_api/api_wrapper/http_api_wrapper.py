...
flight_endpoint = "/flight"
graphics_endpoint = "/graphics"
drawings_endpoint = "/drawings"
...
class HttpAPIWrapper(BasicAPIWrapper):
    ...
    def get_camera(self):
        url = self.base_address + camera_endpoint + self.api_version_str 
    ...
    def set_flight(self, flight):
        url = self.base_address + flight_endpoint + self.api_version_str
        headers = {"content-Type": "application/json"}
    ...
    def add_graphic(self, graphic):
        ...
        graphics_url = self.base_address + graphics_endpoint + self.api_version_str
    ...
    def get_graphic(self, graphic_id):
        graphics_url = self.base_address + graphics_endpoint + "/" + graphic_id + self.api_version_str
        r = requests.get(graphics_url, verify=False)
        return r.status_code, r.json()
    ...
    def update_graphic(self, graphic):
        graphics_url = self.base_address + graphics_endpoint + self.api_version_str
        headers = {"content-Type": "application/json"}
        r = requests.patch(graphics_url, data=json.dumps(graphic), headers=headers, verify=False)
        return r.status_code, {}

    def remove_graphic(self, graphic_id):
        url = self.base_address + graphics_endpoint + "/" + graphic_id + self.api_version_str
        r = requests.delete(url)
        return r.status_code, {} 

    def clear_graphics(self):
        url = self.base_address + graphics_endpoint + self.api_version_str
        r = requests.delete(url)
        return r.status_code, {} 

    def add_drawing(self, drawing):
        url = self.base_address + drawings_endpoint + self.api_version_str
        headers={'content-Type': 'application/json'}
    ...
    def remove_drawing(self, drawing_id):
        url = self.base_address +  drawings_endpoint + "/" + drawing_id + self.api_version_str
        r = requests.delete(url)
        return r.status_code, {}
    ...
    def get_workspace(self):
        url = self.base_address + workspace_endpoint + self.api_version_str
        r = requests.get(url, verify=False)
        return r.status_code, r.json()
    ...
    def get_snapshot(self):
        url = self.base_address + snapshot_endpoint + self.api_version_str
        r = requests.get(url)
