...
def expand_dicts_keys_attributes_to_regular_fields(
    ...
    """Returns an expanded dataframe by converting each attributes of a dict key to an independent column, and also returns all matching fields metadata of the new columns.
    Args:
        data - the original dataframe
        dict-fields - A list of dict fields to expand
    Returns:
        List of tuples. The first element of the tuple is a field metadata and the second one is the corresponding column in the dataframe.
    """
