...
class QtConcurrent(Shiboken.Object):
    ...
    class ReduceOptions(object):
        ...
        def __index__(self) -> int: ...
        def __init__(self, value: typing.Union[int, ReduceOption, ReduceOptions] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __and__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __xor__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __ror__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __rand__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __rxor__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __ior__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __iand__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __ixor__(self, other: typing.Union[int, ReduceOption, ReduceOptions]) -> ReduceOptions: ...
        def __invert__(self) -> ReduceOptions: ...
