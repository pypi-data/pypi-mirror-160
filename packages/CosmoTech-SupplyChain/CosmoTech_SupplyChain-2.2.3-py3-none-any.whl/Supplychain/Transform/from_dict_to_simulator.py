...
class FromDictToSimulatorConverter(Timer):
    ...
    def __operation(self):
        ...
        for operation in operations_csv:
            ...
            operation_item = {
                ...
                "MinimumOrderQuantitySchedule": convert_dict(int,
                                                             float,
                                                             operation['MinimumOrderQuantities']),
                "MultipleOrderQuantitySchedule": convert_dict(int,
                                                              float,
                                                              operation['MultipleOrderQuantities']),
    ...
    def compute_theoretical_maximum_production(self, stock_id: str, time_step: int) -> float:
        ...
        for transport in transports:
            ...
            theoretical_maximum += transport['InitialTransportedQuantities'].get(str(time_step), 0.0)
    ...
    def __transport(self):
        ...
        for transport in transport_csv:
            ...
            transport_item = {
                ...
                "Duration": transport['Duration'],
                "InitialTransportQuantity": convert_dict(int,
                                                         float,
                                                         transport['InitialTransportedQuantities']),
                "InitialTransportValue": convert_dict(int,
                                                      float,
                ...
                "ActualDurationSchedule": convert_dict(int,
                                                       int,
                                                       transport['ActualDurations']),
                "MinimumOrderQuantitySchedule": convert_dict(int,
                                                             float,
                                                             transport['MinimumOrderQuantities']),
                "MultipleOrderQuantitySchedule": convert_dict(int,
                                                              float,
                                                              transport['MultipleOrderQuantities']),
