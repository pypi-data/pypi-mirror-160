...
class PowerBIInfo:
    ...
    def from_dict(obj: Any) -> 'PowerBIInfo':
        ...
        return PowerBIInfo(app, type, workspace)
...
class PowerBIDataset:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataset':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        workspace = from_union([PowerBIWorkspace.from_dict, from_none], obj.get("workspace"))
        return PowerBIDataset(id, app, aspect_type, created_at, description, entity_id, power_bi_dataset_id, latest, name, source_datasets, tables, url, workspace)
