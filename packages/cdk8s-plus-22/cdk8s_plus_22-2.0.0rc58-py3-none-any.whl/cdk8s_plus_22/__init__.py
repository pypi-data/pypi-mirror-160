...
class ContainerResources:
    def __init__(
        self,
        *,
        cpu: typing.Optional["CpuResources"] = None,
        memory: typing.Optional["MemoryResources"] = None,
    ) -> None:
...
@jsii.data_type(
    jsii_type="cdk8s-plus-22.HostPathVolumeOptions",
    jsii_struct_bases=[],
...
@jsii.enum(jsii_type="cdk8s-plus-22.HostPathVolumeType")
